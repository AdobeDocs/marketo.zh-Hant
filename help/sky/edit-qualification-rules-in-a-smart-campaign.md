...
1. 選擇在智慧型促銷活動流程中引導人員的頻率：**[!UICONTROL daily]**、**[!UICONTROL weekly]**、**[!UICONTROL monthly]**&#x200B;或&#x200B;**[!UICONTROL once every # days]**。
   ...
   >[!NOTE]
   >
   >當您每天設定一次規則時，[!DNL Marketo]會將規則轉換為小時。 例如，如果您將規則設為每天一次，而某個人在週日晚上的晚上10點符合資格，則直到星期一晚上10點才能再次符合資格。
   >
...
預設不會將通訊限制套用至智慧型促銷活動。 瞭解如何[將通訊限制套用至智慧型促銷活動](https://docs.marketo.com/display/DOCS/Apply+Communication+Limits+to+Smart+Campaign)。
