...
>合格。 您可以修改此項目以符合您的促銷活動需求。 請參閱復 [雜邏輯的智慧型清單規則](https://docs.marketo.com/display/DOCS/Using+Advanced+Smart+List+Rule+Logic) ，瞭解更多資訊。
>
>若要一次觸發一個人的即時事件，請瞭解如何定義智慧型 [促銷活動的智慧型清單 |觸發器](https://docs.marketo.com/display/DOCS/Define+Smart+List+for+Smart+Campaign+%7C+Trigger)。
