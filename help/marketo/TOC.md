...
+ 產品文件 {#product-docs}
  ...
  + 管理 {#administration}
    ...
    + 設定 {#settings}
      ...
      + {hide-from-toc}[在封存上停用智慧行銷活動](product-docs/administration/settings/disable-smart-campaigns-archive.md)
  ...
  + Marketo Engage的同事 {#coworker-for-marketo}
    ...
    + [組織規則](product-docs/coworker-for-marketo/organizational-rules.md)
    ...
    + 技能 {#skills}
      ...
      + [建置計畫](product-docs/coworker-for-marketo/skills/build-programs.md)
  ...
  + 需求開發 {#demand-generation}
    ...
    + 影像和檔案 {#images-and-files}
      ...
      + [Marketo Engage中的C2PA中繼資料](product-docs/demand-generation/images-and-files/c2pa-metadata.md)
  ...
  + 電子郵件行銷 {#email-marketing}
    ...
    + 電子郵件設計工具 {#email-designer}
      ...
      + [在電子郵件設計工具中使用模組](product-docs/email-marketing/email-designer/email-modules.md)
  ...
  + 報告 {#reporting}
    ...
    + {hide-from-toc}[Marketo活動資料保留原則](product-docs/reporting/data-retention.md)
