...
+ 產品檔案 {#product-docs}
   ...
   + CRM同步 {#crm-sync}
      + Microsoft Dynamics同步 {#microsoft-dynamics}
         ...
         + 同步處理設定 {#sync-setup}
            ...
            + Microsoft Dynamics 365搭配ROPC連線{#microsoft-dynamics-365-with-ropc-connection}
            ...
            + Microsoft Dynamics 365搭配S2S連線{#microsoft-dynamics-365-with-s2s-connection}
   ...
   + Marketo Sales Connect {#marketo-sales-connect}
      ...
      + 電子郵件外掛程式 {#email-plugins}
         ...
         + 適用於Outlook的MSC {#msc-for-outlook}
   ...
   + 網頁個人化 {#web-personalization}
      ...
      + 網頁Personalization的報表 {#reporting-for-web-personalization}
...
+ 發行說明 {#release-notes}
   ...
   + [目前版本TEMP](release-notes/current-temp.md)
   ...
   + 舊版 {#previous-releases}
      + 2025 版 {#2025}
         ...
         + [發行說明： 2025年4月](release-notes/previous-releases/2025/release-notes-apr-25.md)
         + [發行說明： 2025年5月](release-notes/previous-releases/2025/release-notes-may-25.md)
      + 2024 版 {#2024}
