...
## 被封鎖的線索 {#leads-blocked-from-mailings}
...
在5月版中，我們新增了「等待流程」步驟的進階選項。 透過這些變更，您可以指定工作日、日期和時間。 在此版本中，我們新增了在等待步驟中使用代號的功能。 例如，您可能想要在其生日時 `{{lead.Birthday}}` 傳送電子郵件，或用來傳送 `{{my.Event Date}}` 最終網路研討會提醒。

![](assets/image2014-9-23-10-3a25-3a57.png)

## 在Design Studio中檢視為縮圖 {#view-as-thumbnails-in-design-studio}
