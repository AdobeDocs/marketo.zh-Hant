...
## 重新設計電子郵件績效報告 {#email-performance-report-redesign}
...
## 適用於iPad的全新事件登入應用程式 {#new-event-check-in-app-for-ipad}
...
現已針對ON24和Adobe Connect提供！ 在確認電子郵件中加入使用新Token的每位註冊參與者的唯一 `{{member.webinar URL}}` 連結。 Adobe Connect增強功能也包含開啟／關閉Adobe帳戶資訊電子郵件的功能，電子郵件中包含使用者的登入ID和密碼。
...
## 連絡狀態的自訂欄位 {#custom-field-for-contact-status}
...
## 增強的潛在客戶和連絡人訂閱 {#enhanced-lead-and-contact-subscribe}
