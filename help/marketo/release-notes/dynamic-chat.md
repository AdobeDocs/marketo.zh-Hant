...
您現在可以在即時聊天結束後下載聊天記錄的.txt檔案。 [更多資訊](https://experienceleague.adobe.com/zh-hant/docs/marketo/using/product-docs/demand-generation/dynamic-chat/live-chat/agent-inbox#download-transcript){target="_blank"}
