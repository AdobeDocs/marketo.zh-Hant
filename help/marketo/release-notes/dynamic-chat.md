...
## 2026年3月發行版本 {#march-2026-release}
...
<tbody>
  ...
  <tr>
    ...
    <td>xyz</td>
    <td>與現有人員不同</td>
    <td>這種情況不可能發生，就好像它是新的Cookie，預設情況下會被視為新的匿名設定檔</td>
  </tr>
</tbody></table>

### 繼承字型的選項 {#option-to-inherit-font}

您現在可以啟用聊天機器人直接從託管它的網頁繼承字型，而不是在Dynamic Chat中管理品牌字型。 當您啟用此選項時，聊天機器人會採用頁面 `<body>` 標記所定義的字型。
