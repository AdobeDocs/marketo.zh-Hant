...
新的[Analytics首頁](../../product-docs/reporting/basic-reporting/creating-reports/navigating-the-analytics-home-page.md)可讓您快速存取可用報表類型的臨機報表。   ![](assets/image2015-4-20-11-3a18-3a8.png)
...
將您的領先培養策略延伸至付費展示廣告和社交廣告。 [廣告網路整合](../../product-docs/demand-generation/ad-network-integrations/add-linkedin-matched-audiences-as-a-launchpoint-service.md)與LinkedIn Lead Accelerator整合可讓您根據任何智慧型或靜態清單的成員，在LinkedIn中安全地建立觀眾區隔。 然後，LinkedIn觀眾區隔內的成員可以得到一系列相關廣告。
