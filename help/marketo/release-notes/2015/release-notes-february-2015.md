...
**移動 [智慧型促銷活動](../../product-docs/core-marketo-concepts/smart-campaigns/using-smart-campaigns/move-a-smart-campaign.md)**
...
此版本發佈後不久即會發生。 在2015年12月之前， [mktoapi.com](http://mktoapi.com) domain將暫時支援SHA-1通訊協定，讓舊版系統和應用程式的擁有者更新其具備SHA-2相容性的系統。
...
**促銷 [活動的目標URL](../../product-docs/web-personalization/working-with-web-campaigns/adding-a-target-url-to-a-web-campaign.md)**
...
**已 [新增國家和州至以帳戶為主的定位](https://docs.marketo.com/display/DOCS/View+a+Named+Account+List)**
