...
* **Adobe Experience Cloud介面**：將Marketo Engage與Experience Cloud保持一致，以便在單一使用者工作階段中跨多個Experience Cloud解決方案建立一致的導覽體驗。
...
* **Marketo Engage說明中心**：說明中心為Marketo Engage使用者提供中央位置，以便從產品中尋找說明資源。 此外，說明中心讓使用者能夠啟用產品內指南，以說明如何利用關鍵功能。
