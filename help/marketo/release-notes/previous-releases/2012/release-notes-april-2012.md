...
您是否一致地鎖定相同的潛在客戶群組？ 如果是這樣的話，請在智慧清單中使用區段來鎖定潛在客戶。 透過分段，您的整個潛在客戶資料庫總是會分段，並且可以在您的程式中重複使用，以保持一致性。 區段結果會快速提取，因為它們不需要在請求時執行智慧清單。
...
* 新的上傳至清單和排程Campaign API支援上述銷售機會清單和批次行銷活動。
...
我們已建立會顯示每個潛在客戶之唯一註冊確認URL的成員代號，藉此簡化確認URL。 您將不再需要使用不同的權杖建立此URL。 這目前可供GoToWebinar和WebEx客戶使用，並將在我們下一個版本中供Adobe Connect和ON24使用。

![](assets/image2014-9-23-10-3a4-3a18.png)

## 按一下即可上傳多個影像和檔案！ {#upload-multiple-images-and-files-with-a-single-click}

將影像和檔案匯入Marketo時，可節省時間並提高效率！ 如果您使用Firefox或Google Chrome，您可以多選檔案，一次上傳所有檔案。 雖然您可以上傳的檔案數量沒有限制，但每個檔案的個別大小限製為50MB。
