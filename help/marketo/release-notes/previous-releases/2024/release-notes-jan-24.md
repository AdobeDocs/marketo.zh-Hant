...
# 發行說明：2024 年 1 月 {#release-notes-jan-24}

以下是2024年1月發行版本包含的所有功能。 請查看您的 Adobe Marketo Engage 版本是否提供這些功能。
...
下列功能屬於標準發行週期，並將於&#x200B;**2024年1月12日**&#x200B;開始發行，在接下來的幾週內分階段推出剩餘功能。 發行的功能和日期可能有所變更。如需了解各項功能的狀態，請查看其旁邊欄位。
 ...
 <tbody>
  ...
  <tr>
   ...
   <td> </td>
    ...
    <tr>
   <td><strong>代理程式收件匣中最近的Marketo Engage活動</strong>：代理程式收件匣中會顯示最近的Marketo Engage活動，例如「已開啟的電子郵件」和「已填寫的表單」。</td>
   <td><i>即將推出</i></td>
   <td><i>即將推出</i></td>
  </tr>
  <tr>
