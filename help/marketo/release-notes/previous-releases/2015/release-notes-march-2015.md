...
2015年3月發行包含下列功能。 請查看您的Marketo版本，了解功能是否可用。 發行後，請務必回來尋找各功能詳細文章的連結。

## 日曆硬碟 {#calendar-hd}

使用行事歷的新簡報模式顯示您團隊的行銷活動。 這對辦公室的電視或大螢幕都是好東西！ 根據智慧清單或自訂量度來設定和顯示目標。
...
Revenue Explorer具有全新的外觀和風格，以及新的散射環圖類型！ 4月的頭兩週，我們將推出這個。
