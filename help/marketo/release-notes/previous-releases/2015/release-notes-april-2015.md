...
此外，現在還提供私人與共用報表組織。 建立報表或將報表拖曳至您的「我的報表」資料夾，以鎖定報表不讓其他使用者檢視、編輯或刪除。 群組報表會供所有使用者共用。
...
您最愛的Sales Insight功能 — 銷售機會摘要、首選、有趣的時刻，以及新增至Marketo Campaign — 所有這些都可在Salesforce1應用程式上取得。
