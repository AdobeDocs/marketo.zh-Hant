...
<table style="table-layout:auto">
 ...
 <tr>
  ...
  <tr>
   ...
   <td>已發行</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/coworker-for-marketo/skills/product-knowledge" target="_blank">產品知識</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
  ...
  <tr>
   ...
   <td>已發行</td>
   <td><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/coworker-for-marketo/skills/investigate-leads" target="_blank">調查銷售機會</a></td>
  </tr>
  <tr>
   <td> </td>
   <td> </td>
