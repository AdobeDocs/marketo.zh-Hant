...
7月版本預計於7月26日星期五推出，其中包含下列功能。  請檢查您的 [Marketo Edition](http://docs.marketo.com/display/docs/assets/pricing.php) ，以取得功能。

發行後，請務必查看社群中的「 [新發行](release-notes-december-2013.md) 」標籤，以取得每個功能的詳細說明文章！

## 儀表板上用盡的內容介面工具集 {#exhausted-content-widget-on-the-dashboard}
