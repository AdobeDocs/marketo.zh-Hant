...
>[!NOTE]
>
>在[!DNL Microsoft Dynamics]或[!DNL Salesforce]上從[!DNL Sales Insight]傳送電子郵件時，[我的Token](/help/marketo/product-docs/core-marketo-concepts/programs/tokens/understanding-my-tokens-in-a-program.md)無法解析；只會填入標準權杖（銷售機會、公司等）。 不過，代號的預設值仍可運作。
