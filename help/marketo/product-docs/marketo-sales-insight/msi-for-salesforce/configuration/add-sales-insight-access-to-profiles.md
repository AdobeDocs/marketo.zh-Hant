...
1. 從清單中選取您的[!DNL Sales Insight]設定檔，然後從&quot;[!UICONTROL Select Page Layout]&quot;下拉式清單中選取您的[!DNL Sales insight]配置。
...
* 從[!UICONTROL Contacts]、[!UICONTROL Leads]和[!UICONTROL Accounts]的搜尋配置中移除[!DNL Sales Insight]按鈕
