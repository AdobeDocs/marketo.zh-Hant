...
>[!NOTE]
>
>布建Sales Insight Actions時，Marketo會自動將您的憑證傳送至Actions，並將您的執行個體連結至Marketo。 此步驟為必要步驟 **只有在您未看到已建立的連線時** 布建Sales Connect執行個體後。 如果已建立連線，您會在Marketo管理設定頁面上看到您的認證，以及中斷連線的選項。
