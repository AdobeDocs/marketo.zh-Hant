...
# [!DNL Sales Insight Actions]活動字彙表 {#sales-insight-actions-activity-glossary}

在[!DNL Sales Insight Actions]中，當賣家：將銷售機會新增至銷售促銷活動、傳送銷售電子郵件給他們，或進行出站銷售通話時，將會記錄在該銷售機會的Marketo活動歷史記錄下。 此外，當銷售機會與電子郵件、開啟、點按和回覆互動時，也會記錄下來。

以下活動將從[!DNL Sales Insight Actions]記錄到Marketo。
...
<table>
 ...
 <tr>
  ...
  <tr>
   ...
   <td>[!DNL Sales Insight Actions]中個人記錄的唯一識別碼。</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>[!DNL Sales Insight Actions]中促銷活動資產的唯一識別碼。</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>[!DNL Sales Insight Actions] 促銷活動URL。</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>[!DNL Sales Insight Actions]中電子郵件範本的名稱。</td>
  </tr>
  <tr>
   <td><strong>[!UICONTROL Sales Template URL]</strong></td>
   <td>[!DNL Sales Insight Actions] 電子郵件範本的URL。</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>活動的Source。 在2021年10月發行前，將針對[!DNL Sales Insight Actions]個活動設為「Tout」。 在2021年10月發行後，將成為[!DNL Sales Insight Actions]活動的「銷售應用程式」。</td>
  </tr>
  <tr>
   <td><strong>[!UICONTROL Template ID]</strong></td>
   <td>當來源為Tout時，範本識別碼將是[!DNL Marketo Sales Insight Actions]範本識別碼。 使用此項來鎖定特定範本，而非可能存在於多個範本的主旨列。
</td>
  </tr>
 </tbody>
</table>
