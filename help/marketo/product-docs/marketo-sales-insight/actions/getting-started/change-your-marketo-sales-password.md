---
description: 瞭解如何在「銷售Insight動作」中變更Marketo銷售密碼。 不使用「僅限Salesforce」登入時，在「設定」中更新密碼。
...
1. 輸入您目前的密碼。 然後，輸入您的新密碼，然後重新輸入以確保它們相符。 完成後請按一下 **[!UICONTROL Save]**。
...
1. 輸入並確認您的新密碼。 完成後請按一下 **[!UICONTROL Set Password]**。
