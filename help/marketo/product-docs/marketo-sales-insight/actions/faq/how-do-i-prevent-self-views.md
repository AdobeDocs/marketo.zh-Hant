...
## 網頁（[!DNL Outlook]網頁應用程式和Gmail） {#web-outlook-web-app-and-gmail}

[!DNL Marketo Sales]會在您的瀏覽器中儲存Cookie，以防止在從[!DNL Outlook] Web App和Gmail開啟您的電子郵件時追蹤檢視。 如果您還是收到自助檢視，建議您採取下列步驟：
...
1. 在Outlook中，按一下功能表列中的&#x200B;**[!UICONTROL File]**。
...
1. 在Microsoft [!DNL Outlook] Trust Center底下，按一下&#x200B;**[!UICONTROL Trust Center Settings]**。
