---
description: 取得銷售電子郵件中有關內容和檔案附件的常見問題解答。 瞭解大小限制、追蹤和最佳實務。
title: 內容和檔案附件常見問題集
...
**我們用來描述任何檔案（PPT、PDF、Word檔案等）的內容** 您想要由[!DNL Sales Insight Actions]追蹤的內容。

按一下該按鈕後，您就可以選擇已上傳的檔案，或上傳要追蹤的新檔案。 接著，我們會在您使用的電子郵件或範本中插入連結。
