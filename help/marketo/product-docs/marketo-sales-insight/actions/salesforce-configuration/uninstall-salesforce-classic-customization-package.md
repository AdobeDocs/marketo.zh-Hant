---
description: 解除安裝Salesforce Classic自訂套件 — Marketo檔案 — 產品檔案
title: 解除安裝Salesforce Classic自訂套件
hide: true
hidefromtoc: true
...
# 解除安裝Salesforce Classic自訂套件 {#uninstall-salesforce-classic-customization-package}
