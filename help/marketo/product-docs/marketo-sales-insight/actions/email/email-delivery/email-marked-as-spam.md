...
* 電子郵件傳遞通道：您的團隊可選擇使用您的Gmail/Outlook傳遞通道，或設定自訂SMTP。 [按一下這裡](/help/marketo/product-docs/marketo-sales-insight/actions/email/email-delivery/delivery-channel-overview.md)以閱讀更多資訊，瞭解如何根據您的需求選擇正確的傳遞管道。
...
>[!MORELIKETHIS]
>
>[傳遞管道總覽](/help/marketo/product-docs/marketo-sales-insight/actions/email/email-delivery/delivery-channel-overview.md)
