...
建立銷售促銷活動時，您有幾個選項可讓您決定如何在「銷售分析動作」中建立電子郵件步驟。 此外，視您的電子郵件在促銷活動中的位置而定，您的選項也會有所不同。
...
* 此選項會建立電子郵件工作(並同步至Salesforce)，方便您傳送。
* 完成此選取後，當您開始促銷活動時，銷售分析動作會在指揮中心和即時摘要中為您佇列這些任務。 接著，您就可以個人化，並在電子郵件傳送前傳送（或排程）每封電子郵件。
