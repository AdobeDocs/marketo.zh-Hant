...
1. 從Marketo網站商店安裝Google Chrome Add擴充功能的[Chrome Insights ](https://chrome.google.com/webstore/detail/marketo-for-google-mail/jjkfbhajlmoeegbjgjipliamplidmbjb){target="_blank"}。
...
1. 輸入您的&#x200B;**註冊代碼**、**電子郵件地址**、**名字**&#x200B;和&#x200B;**姓氏**。 按一下&#x200B;**驗證並儲存**。
