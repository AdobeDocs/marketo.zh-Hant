...
1. 按一下 **...** 標籤，然後按一下 **傳送Marketo電子郵件**.
   ...
   >[!TIP]
   >
   >您可以 [將電子郵件發佈為範本](/help/marketo/product-docs/marketo-sales-insight/msi-for-salesforce/features/actions-in-the-msi-panel/send-marketo-email/publish-an-email-to-sales-insight.md) 供您的銷售團隊使用。
