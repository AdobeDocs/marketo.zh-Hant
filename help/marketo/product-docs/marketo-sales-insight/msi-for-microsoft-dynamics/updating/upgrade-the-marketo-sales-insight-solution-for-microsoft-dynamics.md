...
title: 升級Microsoft Dynamics的Marketo Sales Insight Solution
...
# 升級Microsoft Dynamics的Marketo Sales Insight Solution {#upgrade-the-marketo-sales-insight-solution-for-microsoft-dynamics}

針對Sales Insight發行新的Microsoft Dynamics解決方案時，您可以從帳戶的「管理員」區域下載「升級」。
...
2. 您將會看到下列快顯視窗。 選取 **暫存升級** 和 **維護自訂**，然後按一下 **匯入**.
