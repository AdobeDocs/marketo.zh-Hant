...
description: 在Microsoft Dynamics 2015中安裝和設定Marketo Sales Insight - Marketo檔案 — 產品檔案
...
Marketo Sales Insight是絕佳的工具，可讓您的銷售團隊透過「視窗」了解行銷團隊所擁有的豐富資料。 以下說明如何在Microsoft Dynamics 201中安裝及設定
...
好，現在是時候將Marketo Sales Insight解決方案導入Microsoft Dynamics了。 方法如下：
...
1. 複製 **Marketo名嘴**, **API URL**，和 **API使用者Id** 以用於後續步驟。 輸入您選擇的API密鑰，然後按一下 **儲存**.
   ...
   >[!NOTE]
   >
   >下列欄位必須與Marketo同步，才能 *銷售機會和聯繫人* 讓Sales Insight發揮作用：
   >
   >* 優先順序
   >* 緊急
   >* 相對分數
