...
description: 瞭解如何在Microsoft Dynamics 2015中安裝和設定Marketo Sales Insight 。 新增解決方案並完成設定。
title: 在 Microsoft Dynamics 2015 中安裝及設定 Marketo 銷售洞察
...
# 在[!DNL Microsoft Dynamics 2015]中安裝並設定[!DNL Marketo Sales Insight] {#install-and-configure-marketo-sales-insight-in-microsoft-dynamics}
...
好，現在可以將[!DNL Marketo Sales Insight]方案匯入[!DNL Microsoft Dynamics]了。 方法如下:
