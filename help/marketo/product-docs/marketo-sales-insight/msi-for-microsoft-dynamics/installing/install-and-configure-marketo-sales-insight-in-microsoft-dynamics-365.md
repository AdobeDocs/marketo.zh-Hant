...
1. 按一下 ![—](assets/image2015-5-13-10-5-8.png) 功能表。 在下拉式清單中，選取 **設定**，然後選取 **解決方案**.
   ...
   >[!NOTE]
   >
   >您應已擁有 [已安裝並設定Marketo解決方案](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-1-of-4-install.md) 再繼續進行。
...
1. 返回Microsoft Dynamics，按一下 ![](assets/image2015-5-13-15-3a49-3a19.png) 圖示加以選取，然後選取 **Marketo API設定** 在下拉式清單中。
