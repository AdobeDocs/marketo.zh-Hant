...
以「System」（系統）或具有要安裝的/i開關的管理用戶帳戶形式運行以下命令行。
...
>[!MORELIKETHIS]
>
>[IT人員解除安裝Marketo Outlook外掛程式](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/marketo-outlook-plugin-uninstall-by-it.md)
