...
>[!PREREQUISITES]
>
>如果尚未安裝，請安裝Outlook的[Marketo電子郵件增益集](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/install-the-marketo-email-add-in-for-outlook-with-a-registration-code.md)。
...
1. 依照正常方式撰寫電子郵件，然後按一下[傳送並追蹤]。****
   ...
   >[!TIP]
   >
   >若要使用Marketo範本，請參閱[使用範本從Outlook傳送及追蹤](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/send-and-track-from-outlook-using-a-marketo-template.md)。
