...
1. 依照正常方式撰寫電子郵件，然後按一下&#x200B;**[!UICONTROL Send and Track]**。
   ...
   >[!TIP]
   >
   >若要使用Marketo範本，請參閱[使用範本](/help/marketo/product-docs/marketo-sales-insight/msi-outlook-plugin/send-and-track-from-outlook-using-a-marketo-template.md)從 [!DNL Outlook] 傳送及追蹤。
...
就是這麼簡單！ 即使此電子郵件是由銷售人員的[!DNL Outlook]傳送，仍會在Marketo中追蹤。
