...
內容推薦引擎會使用預測性分析和機器學習演演算法，將相關內容傳送給每位網頁訪客。 建議引擎會預測哪些內容對每位訪客的表現最好。 引擎的內容會在Recommendations頁面底下受到監控和控制，協助您最佳化內容ROI。
...
1. 若要啟用URL的建議列，只要按一下&#x200B;**[!UICONTROL On]**，然後按&#x200B;**[!UICONTROL Save]**&#x200B;即可。

   ![](assets/bar-enable.png)

1. 若要自訂URL，請選取建議列的顏色、樣式、格式、箭頭以及要包含或排除該列的頁面。 自訂以符合您的網站品牌。 按一下「**[!UICONTROL Save]**」。
...
* 您至少需要一個內容片段，才能讓建議頁面上的建議列設為&#x200B;**[!UICONTROL On]**，讓建議引擎正常運作。 如果未啟用任何內容，且Bar設定為&#x200B;**[!UICONTROL On]**，則會在網頁的右下角顯示箭頭效果，但不會顯示建議的內容。
