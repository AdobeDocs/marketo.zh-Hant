...
您可以在[!UICONTROL All Content]頁面或[!UICONTROL Edit Content]快顯視窗中核准，藉此將[!UICONTROL All Content]頁面上的任何標題新增至預測性內容。
...
1. 在[!UICONTROL Edit Content]快顯視窗中勾選&#x200B;**[!UICONTROL Approve for Predictive Content]**&#x200B;方塊並按一下&#x200B;**[!UICONTROL Save]**。
