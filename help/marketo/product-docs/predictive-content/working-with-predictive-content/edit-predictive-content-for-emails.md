...
1. 按一下「**[!UICONTROL Save]**」。
   ...
   >[!NOTE]
   >
   >在Marketo電子郵件編輯器v2.0中，您也可以[檢視啟用內容時所使用的版面配置範本](/help/marketo/product-docs/predictive-content/enabling-predictive-content/enable-predictive-content-in-emails.md)。
