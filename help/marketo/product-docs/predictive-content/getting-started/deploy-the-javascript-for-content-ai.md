...
1. 登入您的預測性內容帳戶。 移至&#x200B;**帳戶設定**。

   ![](assets/settings-dropdown-account-hands.png)

1. 在&#x200B;**網域組態**&#x200B;中，找出相關網域並按一下&#x200B;**產生標籤**。

   ![](assets/generate-tag.png)

1. 將網頁Personalization標籤複製並貼到網站的HTML中。
...
1. 確認標籤是否會出現在所有頁面上，包括登陸頁面和子網域。 請在您網站的頁面上按一下滑鼠右鍵，以勾選此選項。 前往網頁瀏覽器中的&#x200B;**檢視頁面Source**。 搜尋： &#39;RTP&#39;。
