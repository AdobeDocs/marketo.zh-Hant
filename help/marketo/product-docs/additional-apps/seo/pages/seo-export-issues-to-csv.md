...
description: 將頁面最佳化問題從頁面詳細資料向下展開以在Marketo外部共用，匯出為CSV檔案。
...
如果您想要與Marketo以外的人員共用頁面問題資料，可將該資料匯出至CSV檔案。 方法如下。
...
1. 按一下您要檢視其詳細資訊的頁面。
   ...
   這是頁面詳細資料向下展開。 **[!UICONTROL Page Optimization Results]**&#x200B;是該特定頁面所有問題的清單。
