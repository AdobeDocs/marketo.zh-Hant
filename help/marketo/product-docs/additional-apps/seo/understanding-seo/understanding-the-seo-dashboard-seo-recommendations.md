...
description: 使用SEO儀表板建議區段來尋找最熱門的頁面最佳化問題和最熱門的連結機會，以改進您的網站。
...
# 認識 SEO 儀表板：SEO 推薦 {#understanding-the-seo-dashboard-seo-recommendations}
...
>[!TIP]
>
>您可以按一下[!UICONTROL Top Page Optimization Issues]檢視完整清單。
...
>[!TIP]
>
>您可以按一下[!UICONTROL Top Link Optimization]檢視完整清單。
