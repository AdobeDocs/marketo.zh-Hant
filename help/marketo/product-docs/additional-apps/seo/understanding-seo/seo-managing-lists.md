...
新增關鍵字、頁面、頁面問題或入站連結時，您可以將項目新增至清單。 清單可協助您保持井然有序，並讓您篩選報表，只查看該清單上的資料。 以下說明如何製作這些範本：

1. 按一下 **新增關鍵字**.

   >[!NOTE]
   >
   >這在新增頁面、頁面問題和入站連結時的運作方式相同。

   ![](assets/image2014-9-18-13-3a24-3a35.png)

1. 輸入關鍵字。 從下拉式清單中選取要新增至的清單。

   ![](assets/image2014-9-18-13-3a24-3a50.png)

   >[!TIP]
   >
   >您可以在下拉式清單中建立新清單。 輸入標題，點擊傳回索引鍵。
