...
description: 依清單、SERP排名範圍或搜尋欄位篩選關鍵字結果，以尋找所需的關鍵字。
title: SEO - 篩選關鍵字結果
...
您可能有許多[關鍵字](/help/marketo/product-docs/additional-apps/seo/keywords/seo-understanding-keywords.md)。 以下是篩選它們的不同方法。
