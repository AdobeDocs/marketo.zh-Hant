...
1. 移至&#x200B;**Analytics**&#x200B;並選取您的&#x200B;**成功路徑分析器**。

   ![](assets/image2015-6-12-17-3a23-3a53.png)

   右側的圖表會在左側的所選按鈕中反映資料。 依預設，這是「平衡」。

1. 按一下流量&#x200B;**中的**，以圖形化在選取的時間範圍內有多少人進入階段。
...
1. 若要變更圖表的時間比例，請按一下&#x200B;**圖表依據**&#x200B;按鈕之一：每日（預設）、每週和每月

   ![](assets/image2015-6-12-17-3a46-3a55.png)

1. 針對具有SLA （服務等級協定）的階段，按一下&#x200B;**圖表動作** > **顯示SLA到期日**，以顯示指定時間範圍內遺漏SLA目標的每個人。
...
1. 圖表會更新，以反映每個節點到期的SLA數量（橘色）。
   ...
   以橘色顯示的人員可能仍在SLA階段中&#x200B;*或*。

1. 按一下&#x200B;**圖表動作** > **顯示SLA逾期**，以顯示所有具有過期的SLA目標且在指定時段結束時仍處於SLA階段的人員。
