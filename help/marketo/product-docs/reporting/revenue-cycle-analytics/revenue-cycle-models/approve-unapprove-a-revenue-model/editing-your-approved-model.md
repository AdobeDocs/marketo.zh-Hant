...
description: 瞭解如何在Marketo Engage中編輯已核准的模型，包括編輯已核准的模型。 使用本指南完成您的下一個步驟。
title: 編輯已核准的模型
...
1. 當您完成模型的變更後，請在&#x200B;**[!UICONTROL Model Actions]**&#x200B;功能表中選取&#x200B;**[!UICONTROL Approve Model Draft]**&#x200B;以重新核准模型。
