...
進一步瞭解 [Google的離線轉換匯入功能](https://support.google.com/adwords/answer/2998031?hl=en). 將AdWords離線轉換對應至收入模型中的一或多個階段。 有三種方式可以進行對應：
...
1. 選取 **AdWords轉換**.
   ...
   **秘訣**：如果您沒有任何AdWords轉換，請按一下以建立轉換 **+新增轉換**.
