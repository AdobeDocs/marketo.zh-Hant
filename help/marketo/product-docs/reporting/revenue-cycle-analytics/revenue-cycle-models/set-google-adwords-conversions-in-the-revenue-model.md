...
description: 瞭解如何使用設定dnl google，在Marketo Engage的收入模型中設定[！dnl google adwords]轉換。 使用本指南完成您的下一個步驟。
...
您也可以在&#x200B;**[!UICONTROL Stage Actions]**&#x200B;下對應[!UICONTROL AdWords Conversion]。
...
您可以使用[!DNL AdWords]對應將所有模型階段與[!UICONTROL AdWords Conversion]在一個位置建立關聯。
