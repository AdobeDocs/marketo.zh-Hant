...
若要檢視您的電子郵件效能統計資料，請依 [智慧型行銷活動](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/understanding-batch-and-trigger-smart-campaigns.md)，執行Campaign電子郵件效能報表。
...
1. 現在探索該報告，瞭解行銷活動中的每個電子郵件是如何執行的。
   ...
   [您可以選取的欄](/help/marketo/product-docs/reporting/basic-reporting/editing-reports/select-report-columns.md)促銷活動電子郵件績效報表包含：
   ...
   >[!NOTE]
   >
   >一般而言，我們會嘗試用常識來記錄這些統計資料。 例如，如果有人按一下電子郵件中的連結，很明顯會先開啟該連結。 如需瞭解我們遵循的特定規則，請參閱 [電子郵件效能報表](/help/marketo/product-docs/email-marketing/email-programs/email-program-data/email-performance-report.md).
