...
description: 瞭解顯示哪些公司正在依公司分組造訪您的網站的公司網站活動報表。 顯示已知或匿名的訪客，以及追蹤頁面檢視、人員和地理位置。
title: 公司網頁活動報告
...
<table>
 ...
 <tbody>
  <tr>
   <td>公司</td>
   <td>訪客的公司。<br> 至少有一個人已確認粗體的<strong>名稱</strong>為公司名稱。</td>
  </tr>
  <tr>
   <td>推斷的公司或ISP</td>
   <td>從訪客的IP位址推斷的公司。<br> <strong>名稱以粗體顯示</strong>表示這是公司，而非ISP。 </td>
  </tr>
  <tr>
   <td>頁面檢視</td>
   <td>訪客載入的頁數。</td>
