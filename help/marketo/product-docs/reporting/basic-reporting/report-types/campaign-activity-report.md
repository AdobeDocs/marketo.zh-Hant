...
1. 太棒了！ 探索您的報告，依行銷活動型別分組，以識別您最有效的行銷活動。

   ![](assets/image2014-9-16-16-3a8-3a45.png)

   >[!TIP]
   >
   >例如，若要尋找處理最多人的行銷活動， [排序您的報告](/help/marketo/product-docs/reporting/basic-reporting/editing-reports/sort-report-on-columns.md) 於 _已處理人員總數_ 並選擇 **降序排序**.
   ...
   |---|---|
   | 批次 | 批次促銷活動 **行銷活動** 標籤。 |
   | 執行動作 | 人員作業從以下專案執行： **資料庫**. |
   | 已觸發（作用中） | 中目前觸發的行銷活動 **行銷活動** 標籤。 |
   | 已觸發（非使用中） | 非使用中觸發的行銷活動 **行銷活動** 標籤。 |
