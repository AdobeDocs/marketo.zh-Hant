...
1. 選擇在報 [表中顯示已知或匿名](../../../../product-docs/reporting/basic-reporting/report-activity/display-people-or-anonymous-visitors-in-web-reports.md) 的人員。
...
1. 你懂的！ 檢閱您的報表，以瞭解訪問您網站的訪客。
   ...
   >[!TIP]
   >
   >若要找出誰瀏覽您網站的次數最多，請在「頁 [面檢視」欄上對報](../../../../product-docs/reporting/basic-reporting/editing-reports/sort-report-on-columns.md) 表排序 [](../../../../product-docs/reporting/basic-reporting/editing-reports/sort-report-on-columns.md)，並選 ** 擇「排序遞減」。

   [Marketo會將匿名網站訪客新增至您的資料庫](../../../../product-docs/reporting/basic-reporting/report-activity/tracking-anonymous-activity-and-people.md) ，而您可以選擇在此報表中顯示這些訪客。 它提供了豐富的資訊，即使這些資訊是匿名的。\
   [您可以為「網頁活動](../../../../product-docs/reporting/basic-reporting/editing-reports/select-report-columns.md) 」報表選取的欄包括：
...
<table> 
 ...
 <tbody> 
  <tr> 
   <td>人物</td> 
   <td>訪客的名稱、標題和公司。<br><strong>按一下</strong> ，查看人員詳細資訊和活動歷史記錄。</td> 
  </tr> 
  <tr> 
   <td>首次／上次瀏覽（時區）</td> 
  ...
  <tr> 
   <td>頁面檢視</td> 
   <td>此訪客載入的頁面數。<br><strong><a href="web-page-activity-report/web-pages-viewed-web-page-activity-report.md">按一下</a></strong> ，以檢視已瀏覽的頁面。</td> 
  </tr> 
  <tr> 
   <td>HTTP Referer</td> 
  ...
  <tr> 
   <td>推斷的公司或ISP</td> 
   <td>根據訪客的IP位址推斷的公司。 <strong>用粗體表示</strong> ，這是公司，而不是ISP。 </td> 
  </tr> 
  <tr> 
   <td>推斷的國家、州／地區和城市</td> 
...
>**深入探討**
>
>瞭解「基本報告」中其他有 [趣的報告](http://docs.marketo.com/display/docs/basic+reporting)。
