...
<table>
 <tbody>
  <tr>
   ...
   <td colspan="1">如果您使用Marketo ABM，所有帳戶清單都會同步至MPI，並可透過「ABM帳戶清單」篩選器顯示。 您可以選取帳戶清單，以篩選這些帳戶的結果。<a href="https://docs.marketo.com/display/public/DOCS/Account-Based+Web+Marketing+with+ABM" rel="nofollow">進一步瞭解ABM帳戶清單。</a></td>
  </tr>
  <tr>
