---
description: 瞭解Advanced BI Analytics，這是一個彈性的報告介面，具有豐富的視覺效果和更快的Marketo Engage資料效能。 使用互動式控制面板和匯出選項建立自訂報表。
title: 進階 BI 分析概觀
feature: Reporting
...
* **豐富且吸引人的視覺效果**：包含圖表、地圖及KPI指標在內建的視覺效果選項集合大幅擴充，讓儀表板更具深入解析度及影響力，並大幅增強資料storytelling。
...
>[!VIDEO](https://video.tv.adobe.com/v/3451693/?captions=chi_hant&quality=12&learn=on){transcript=true}
