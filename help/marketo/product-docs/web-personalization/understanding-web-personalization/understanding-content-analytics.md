...
* 依時間範圍（日、周和月）篩選
* 依內容標題和內容URL搜尋
* 按一下「檢視」、「直接轉換」和「轉換率」的欄標題，以遞減或遞增順序排序。

![](assets/content-analytics-8-29-16-blur.png)

您也可以按一下圖示，以CSV格式匯出檔案。
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1" rowspan="1"><p>內容資產上網站訪客的檢視次數。 檢視、開啟、觀看或下載的次數。 按一下檢視欄中的數目，以深入檢視並查看誰檢視了內容</p></td> 
  </tr> 
  <tr> 
...
* **檢視**:所選時間範圍內該內容片段的檢視
* **直接轉換**:在同一次瀏覽中檢視內容並填寫表單的網頁訪客。
* **轉換率****:**由「直接轉換」除以「點按」計算的轉換率百分比
...
在「內容分析」頁面中，按一下您要刪除之內容的刪除圖示。 出現一則訊息，確認您要刪除「內容」。
