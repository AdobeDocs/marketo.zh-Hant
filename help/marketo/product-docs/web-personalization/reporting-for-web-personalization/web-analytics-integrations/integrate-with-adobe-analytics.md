...
description: 瞭解如何使用與Adobe Analytics整合來與Marketo Engage中的Adobe Analytics整合。 使用本指南完成您的下一個步驟。
...
1. 前往 **[!UICONTROL Site Metrics]**。 按一下&#x200B;**[!UICONTROL Custom Events]**，**[!UICONTROL Segments]**。
