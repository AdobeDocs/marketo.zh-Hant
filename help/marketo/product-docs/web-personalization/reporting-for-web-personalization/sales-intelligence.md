...
若要根據地區、國家或州定義您在Marketo Web Personalization中看到的組織和訪客資料，請移至[使用者設定](/help/marketo/product-docs/web-personalization/getting-started/user-settings.md)並選取國家或州。

## 設定每日或每週電子郵件報告 {#set-up-daily-or-weekly-email-reports}

在[使用者設定](/help/marketo/product-docs/web-personalization/getting-started/user-settings.md)中，您可以將設定為接收每天或每週的電子郵件報告，這些報告會在清晨發出。 銷售主管感興趣的主要報表包括「組織」和「銷售機會」報表，這些報表會顯示使用者特定區域所造訪的最上層組織和提交的銷售機會（包括其行為）。
