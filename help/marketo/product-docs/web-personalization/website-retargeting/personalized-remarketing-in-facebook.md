...
個人化再行銷可讓您使用RTP資料和Facebook再行銷的強大功能，重新與使用者互動。
...
>* 檢閱 [](https://developers.facebook.com/docs/ads-for-websites/website-custom-audiences/getting-started#install-the-pixel) [關於自訂對象的Facebook檔案](https://developers.facebook.com/docs/ads-for-websites/website-custom-audiences/getting-started#install-the-pixel) 和再行銷。

## 在Facebook中建立對象 {#creating-an-audience-in-facebook}

1. 在Facebook中，前往 [對象標籤](https://www.facebook.com/ads/audience_manager) 在「廣告管理員」中。
...
1. 在此範例中，選取要包含的產業 **教育**. 輸入 **教育**，並編輯 **最近** 為180天。 輸入對象名稱： **教育產業**. 按一下 **建立對象**.
    ...
    <div> 
     <table> 
      <tbody> 
       ...
       <tr> 
        <td colspan="1">類別</td> 
        <td colspan="1"><p>財富500強</p><p>《財富》1000強</p><p>2000年全球</p></td> 
       </tr> 
       <tr> 
        <td colspan="1">群組</td> 
       ...
       <tr> 
        <td>產業</td> 
        <td><p>防禦</p><p>教育</p><p>金融服務</p><p>政府</p><p>醫療保健、製藥、生物科技</p><p>軟體與網際網路</p><p>等等…… （根據RTP產業選項）</p></td> 
       </tr> 
       <tr> 
        <td colspan="1">區段對象</td> 
...
## 使用廣告鎖定您的對象 {#target-your-audience-with-an-ad}
