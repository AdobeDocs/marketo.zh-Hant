...
1. 前往 **帳戶設定**.
   ...
   a.如果您已從「支援」收到JavaScript標籤，請繼續進行步驟6。
...
1. 複製RTP JavaScript標籤並貼到新的 **自訂HTML標籤** 您已建立（步驟1）。

1. 按一下 **+新增規則至引發標籤**. 選擇 **所有頁面**.

1. 按一下 **儲存** 和 [發佈新版本](https://support.google.com/tagmanager/answer/2699097?hl=en).

1. 確認其顯示在所有頁面上，包括登錄頁面和子網域。

   a.若要這麼做，請在網站的頁面上按一下滑鼠右鍵。 前往 **Inspect元素**，搜尋 **RTP** 來尋找標籤。
