...
若要在Web個人化中的工作區之間切換，請按一下左上方的球形圖示，然後從下拉式選單中選擇不同的工作區。
...
>[!NOTE]
>
>使用者將只能檢視與其有權存取的工作區相關聯的網頁行銷活動和區段。 以下說明操作方法 [授予使用者存取一或多個工作區的許可權](/help/marketo/product-docs/administration/workspaces-and-person-partitions/allow-user-access-to-a-workspace.md).
