...
1. 按一下「**[!UICONTROL Roles]**」。
   ...
   >[!NOTE]
   >
   >如果網頁Personalization (WP)使用者角色已經存在，請確定已將其設定為如步驟4中所示。

1. 按一下「**[!UICONTROL New Role]**」。

   ![](assets/three-1.png)

1. 輸入[!UICONTROL Role Name]並選取[!UICONTROL Permissions]。 按一下&#x200B;**[!UICONTROL Create]** （此角色必須[套用至所有工作區](/help/marketo/product-docs/administration/users-and-roles/edit-user-workspaces.md)）。
