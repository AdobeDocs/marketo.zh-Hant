...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colspan="1" rowspan="1">自訂Widget按鈕本身。<br>箭頭：可讓您從右方下拉式選單中的多個不同圖示中選擇。 左側下拉式清單決定其色彩。<br>自訂：插入任何託管影像的URL。 接受的檔案型別 — .JPEG、.GIF （包括動畫）、.PNG、.APNG、.SVG、.BMP。<br>文字：Widget可以是文字 — 自訂其色彩、大小和字型。</td>
  </tr>
  <tr>
...
>[!NOTE]
>
>**要進行A/B測試您的網路行銷活動？** 一或多個網頁行銷活動可以進行[A/B測試以獲得最佳結果](/help/marketo/product-docs/web-personalization/working-with-web-campaigns/ab-test-your-web-campaign.md)。 透過[!UICONTROL Auto Tune]功能，平台會自動辨識表現較佳的促銷活動，繼續最高的轉換促銷活動，並暫停其他促銷活動。
