...
若要A/B測試您的個人化行銷活動，您可以選取兩個或多個行銷活動，將它們關聯至相同的&#x200B;**分割測試**&#x200B;群組，並選取&#x200B;**自動調整**&#x200B;以自動繼續最佳績效行銷活動。
...
1. **儲存**&#x200B;或&#x200B;**啟動**&#x200B;行銷活動。
   ...
   >[!TIP]
   >
   >選取&#x200B;**自動調整**&#x200B;可讓Web Personalization平台自動辨識表現較佳的分割測試行銷活動，並在暫停其他行銷活動時繼續轉換最高的行銷活動。
...
1. 在&#x200B;**設定行銷活動**&#x200B;頁面中，選取&#x200B;**分割測試**，然後從下拉式清單中選擇&#x200B;**群組**。 選取&#x200B;**自動調整**。
...
1. 在&#x200B;**網路行銷活動**&#x200B;中，您可以看到A/B圖示所代表的分割測試行銷活動。
