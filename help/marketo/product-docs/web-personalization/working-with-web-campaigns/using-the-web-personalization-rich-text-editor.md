...
在[!UICONTROL Set Campaigns]頁面中找到的[!DNL Web Personalization] RTF編輯器允許文字格式化、連結和影像插入。 它包含與標準文書處理器類似的格式化選項。
...
>[!NOTE]
>
>Web Token使用您[!DNL Marketo Database]中的[人員資料](/help/marketo/product-docs/web-personalization/using-web-segments/manage-person-data.md)，該資料是在[!DNL Web Personalization]中的[!UICONTROL Account Settings] > [!UICONTROL Database]下管理的。 如果Web權杖是[!UICONTROL Account Settings] > [!UICONTROL Database]中尚未顯示的新資料庫欄位，則會自動新增該權杖，且最多可能需要24小時才能啟用。
