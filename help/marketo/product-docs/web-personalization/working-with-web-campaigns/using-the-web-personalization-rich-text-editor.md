...
「設定促銷活動」頁面中的「網頁個人化」富格文字編輯器可讓您進行文字格式設定、連結和影像插入。 它包含與標準字處理器類似的格式化選項。
...
>[!MORELIKETHIS]
>
>[使用Rich Text編輯器](http://docs.marketo.com/display/docs/using+the+rich+text+editor#usingtherichtexteditor-features)
