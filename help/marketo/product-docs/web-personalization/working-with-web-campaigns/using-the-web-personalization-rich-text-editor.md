...
# 使用[!DNL Web Personalization] RTF編輯器 {#using-the-web-personalization-rich-text-editor}

![](assets/one.png)

在[!DNL Web Personalization]頁面中找到的[!UICONTROL Set Campaigns] RTF編輯器允許文字格式化、連結和影像插入。 它包含與標準文書處理器類似的格式化選項。
...
>[!NOTE]
>
>Web Token使用您[中的](/help/marketo/product-docs/web-personalization/using-web-segments/manage-person-data.md)人員資料[!DNL Marketo Database]，該資料是在[!DNL Web Personalization]中的[!UICONTROL Account Settings] > [!UICONTROL Database]下管理的。 如果Web權杖是[!UICONTROL Account Settings] > [!UICONTROL Database]中尚未顯示的新資料庫欄位，則會自動新增該權杖，且最多可能需要24小時才能啟用。
