...
當您排程參與計畫串流且收件者時區啟用時，計畫轉播將於第一個時區的午夜(UTC +14:00)開始執行。 我們要求您在未來至少安排25小時&#x200B;**的首次投影片，因為全球每個時區都可能有人符合投影片資格。**&#x200B;首次在時區開始處理時，我們保證會在每個收件者的排程日期和時間傳送電子郵件。

1. 在您的參與程式中，導覽至&#x200B;**串流**&#x200B;標籤，然後按一下串流的節目排程以加以編輯。

   ![](assets/image2017-12-5-13-3a36-3a21.png)

1. [設定您的節](/help/marketo/product-docs/email-marketing/drip-nurturing/engagement-program-streams/set-stream-cadence.md) 目設定，以正常方式設定，然後核取「收件者 **時間** 區域」。請記住，您的第一部影片未來必須至少25小時。 按一下&#x200B;**保存**。
