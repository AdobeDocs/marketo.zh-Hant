...
description: 設定資料流步調 — Marketo檔案 — 產品檔案
title: 設定資料流步調
...
您可以依需要的任何間隔傳送參與內容。 例如：一週一次，或每個月的第三個星期二。
...
1. 決定一週的哪幾天。 在這種情況下，讓我們在星期二、星期三和星期四進行。
   ...
   >[!TIP]
   >
   >您可以藉由挑選將步調設定為每天執行 **重複：每週** / **每： 1週** / **開啟**：所有日。
   ...
   >[!CAUTION]
   >
   >內容將在您為首次播放選取的日期外出，因此請確保它與您選擇的一週中的第幾天一致；否則將在第一週外出兩次。

1. 暫留在步調上。 您會看到未來何時進行投影。

   ![](assets/image2017-12-5-14-3a17-3a29.png)

   >[!NOTE]
   >
   >在此範例中，電子郵件將於星期四寄出。 然後，我們略過一週，並在下週的週二、週三和週四再次傳送。 然後再次循環。
...
1. 選取是否希望它每個月或更久地間隔開……讓我們選取每個第四個月。

   ![](assets/image2014-9-15-16-3a30-3a7.png)

1. 選擇您指定的月份日期，在此例中是每四個月的第22天。
