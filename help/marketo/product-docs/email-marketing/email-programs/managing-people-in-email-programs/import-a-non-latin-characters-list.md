...
description: 瞭解如何為電子郵件程式匯入包含非拉丁字元的清單。 確保針對國際受眾進行編碼和格式化。
title: 匯入非拉丁字元清單
...
1. 從Excel的&#x200B;**[!UICONTROL File]**&#x200B;功能表選取&#x200B;**[!UICONTROL Save As]...**。
...
1. 從&#x200B;**[!UICONTROL Edit]**&#x200B;功能表選取&#x200B;**[!UICONTROL Find and Replace]...**。
