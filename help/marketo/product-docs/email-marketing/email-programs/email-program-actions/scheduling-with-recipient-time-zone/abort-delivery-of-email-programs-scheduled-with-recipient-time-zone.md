...
description: 中止傳送以收件者時區排程的電子郵件計畫 — Marketo檔案 — 產品檔案
...
由於使用收件者時區排程的電子郵件程式最多可執行24小時，因此中止程式傳送將會取消該時間點之後的任何後續傳送。
...
1. 取消後， **結果** 您的電子郵件程式的方格看起來會類似於下面的方格。 任何後續傳送都會被取消，並會在「 」中顯示為「電子郵件已軟退回」。 **活動型別** 欄。

   ![](assets/image2018-2-23-11-3a22-3a11.png)

   >[!NOTE]
   >
   >取消的電子郵件將 **not** 顯示為軟退信 *直到* 原本排程在各自時區傳送的時間。 在此之前，它們仍會顯示為「傳送電子郵件」。

1. 在網格中，您可以按一下任何電子郵件來檢視活動詳細資訊。 對於已取消的傳送，詳細資訊快顯視窗將如下所示：
