...
description: 瞭解電子郵件編輯器2.0與新電子郵件Designer之間的功能差異。 使用表格來比較功能的可用性。
...
<tbody>
  ...
  <tr>
    <td>動態內容/條件式內容</td>
    <td>能夠根據目標對象，在電子郵件中<a href="/help/marketo/product-docs/email-marketing/email-designer/conditional-content.md" target="_blank">建立變體</a>。</td>
    <td>可用</td>
    <td>可用</td>
  </tr>
  <tr>
  ...
  <tr>
    <td>HTML編輯器</td>
    <td>能夠修改<a href="/help/marketo/product-docs/email-marketing/email-designer/advanced-html-mode.md">電子郵件範本</a>的HTML內容。</td>
    <td>可用</td>
    <td>可用</td>
  </tr>
  <tr>
