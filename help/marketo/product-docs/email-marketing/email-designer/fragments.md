...
product: marketo
title: 片段
description: 瞭解如何建立和使用片段作為可重複使用的電子郵件元件。 將視覺化內容片段新增至電子郵件和範本。
...
1. 按一下&#x200B;_主題_&#x200B;圖示。
   ...
   >[!INFO]
   >
   >深入瞭解[主題設定](/help/marketo/product-docs/email-marketing/email-designer/brands/brand-themes.md#settings){target="_blank"}。
...
1. 若要更新內容，請按一下右上方的&#x200B;**[!UICONTROL Create draft version]**。
   ...
   在對話方塊中按一下&#x200B;**[!UICONTROL OK]**，在視覺化設計工具中開啟草稿版本。 您可以變更`image source`。
...
* 按一下&#x200B;_更多_&#x200B;圖示(**...**) 在片段名稱旁邊，並選擇&#x200B;**[!UICONTROL Open draft version]**。
...
* 從&#x200B;_[!UICONTROL Fragments]_&#x200B;清單頁面，按一下_&#x200B;更多&#x200B;_圖示(**...**) 在片段名稱旁邊，並選擇&#x200B;**[!UICONTROL Duplicate]**。
...
>[!NOTE]
>
>如果電子郵件中停用&#x200B;_與HTML_&#x200B;的同步，則所做的變更（包括中斷繼承）將不會反映在文字內容中。
