...
description: 瞭解如何使用Adobe Express在電子郵件Designer中編輯影像。 在不離開Marketo Engage的情況下開啟和調整影像。
...
![調整影像視窗大小，顯示所有可用選項](assets/edit-images-with-adobe-express-5.png){width="800" zoomable="yes"}
