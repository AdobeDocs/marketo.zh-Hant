...
Marketo Engage電子郵件Designer中的AI Assistant內容加速器可幫助您建立當代、高效能且直覺式的電子郵件。 這是透過Adobe的創作AI技術和提示程式庫以及影像產生的Firefly來達成，有助於為特定角色/購買群組、行銷歷程階段、溝通策略、色調等建立適合的內容。 也可以使用特定品牌資產來建立內容。
...
啟用AI Assistant內容加速器的&#x200B;**使用參考內容**&#x200B;選項，以根據選取的內容個人化新內容。
