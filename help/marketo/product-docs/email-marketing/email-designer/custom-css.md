...
1. 從左側的&#x200B;**[!UICONTROL Navigation tree]**&#x200B;或右側窗格中選取&#x200B;**[!UICONTROL Body]**。 **[!UICONTROL CSS styles]**&#x200B;顯示在右側。
...
1. 在彈出的專用文字區域中輸入您的CSS代碼。 請確定自訂CSS [有效並遵循正確的語法](#use-valid-css)。 完成時，按一下&#x200B;**儲存**。
   ...
   >[!NOTE]
   >
   >使用包含鎖定內容](/help/marketo/product-docs/email-marketing/email-designer/content-locking.md)的[範本時，您無法新增自訂CSS至您的內容。 按鈕標籤變更為&#x200B;**[!UICONTROL View custom CSS]**，且顯示的任何自訂CSS都是唯讀的。
