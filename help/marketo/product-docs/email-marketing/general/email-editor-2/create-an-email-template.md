...
1. 若要開始編輯您的新範本，請按一下 **編輯草稿**.
   ...
   >[!CAUTION]
   >
   >雖然沒有硬性限制，但一旦電子郵件範本被超過500封電子郵件使用，在更新後重新核准該範本可能會導致效能問題。 我們建議在電子郵件範本有500封電子郵件與之相關聯後，再建立新範本。

## 將電子郵件另存為範本 {#save-an-email-as-a-template}

如果您已建立電子郵件，但想儲存為範本以供日後使用，請依照下列簡單步驟進行。
...
1. 按一下 **資料夾** 下拉式清單，選取您希望範本存在的位置，然後按一下 **儲存**.
