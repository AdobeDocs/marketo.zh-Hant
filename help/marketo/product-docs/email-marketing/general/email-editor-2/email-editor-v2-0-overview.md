...
>[!IMPORTANT]
>
>雖然未設定確切日期，但傳統電子郵件編輯器可能會在 2027 年淘汰 (我們在確定後會宣佈確切日期)。強烈建議您開始採用進階[電子郵件設計工具](/help/marketo/product-docs/email-marketing/email-designer/overview.md){target="_blank"}，因為其具有許多傳統編輯器無法提供的功能。
