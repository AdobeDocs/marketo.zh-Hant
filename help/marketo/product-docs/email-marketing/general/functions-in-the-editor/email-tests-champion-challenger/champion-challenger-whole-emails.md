...
description: Champion/Challenger — 整封電子郵件 — Marketo檔案 — 產品檔案
title: 冠軍/挑戰者 — 整封電子郵件
...
1. 拖曳滑桿以決定收到挑戰者與冠軍電子郵件之人員的百分比分割。
   ...
   >**範例**
   >
   >在上述分佈中，智慧清單中指定的受眾總數中，有15%會收到挑戰者電子郵件之一，而85%會收到冠軍電子郵件。 多個挑戰者電子郵件共用的15%相同。 測試完成後，您可以手動宣告獲勝者。 從那時起，所有未來的人都會獲得表現較好的內容。

   若要取得統計上的可信度，請確定您指派給挑戰者的百分比包含足夠的人員，讓您的測試有效。 不要被沒有結果的結果所愚弄。

   [前所未有的統計可信度相關資訊](https://en.wikipedia.org/wiki/Confidence_interval).
