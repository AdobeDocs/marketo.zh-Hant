...
* 您在Marketo Engage中為[輸入的 [!DNL Veeva]](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/enterprise-unlimited-edition/step-2-of-3-create-a-salesforce-user-for-marketo-enterprise-unlimited.md){target="_blank"}認證可用來同步資料。 只有這些認證可存取的資料才會包括在內。
