...
1. 按一下導覽搜尋列中的&#x200B;**[!UICONTROL Account]** （個人帳戶）頁面配置，而不按Enter，然後按一下[!UICONTROL Contacts]底下的&#x200B;**[!UICONTROL Page Layout]**。
...
1. 在[!UICONTROL General User Permissions]區段下，確認已選取[!UICONTROL Edit Events]和[!UICONTROL Edit Tasks]。

   ![](assets/step-2-of-3-create-a-veeva-crm-user-13.png)

1. 在[!UICONTROL Standard Object Permissions]區段下，確定已檢查[!UICONTROL Accounts]與[!UICONTROL Contacts]的[!UICONTROL Read]、[!UICONTROL Create]、[!UICONTROL Edit]與[!UICONTROL Delete]許可權。

   ![](assets/step-2-of-3-create-a-veeva-crm-user-14.png)

1. 在[!UICONTROL Custom Object Permissions]區段下，確定已針對[!UICONTROL Call]、[!UICONTROL Call Key Message]和其他任何需要的自訂物件檢查[!UICONTROL Read]許可權。
...
1. 在導覽搜尋列中輸入「使用者」，然後按一下[!UICONTROL Manage Users]下方的&#x200B;**[!UICONTROL Users]**。
...
>[!TIP]
>
>確認您輸入的電子郵件地址有效。 您必須以同步處理使用者身分登入，才能重設密碼。

現在您已擁有Marketo Engage可用來連線至[!DNL Veeva] CRM的帳戶。
