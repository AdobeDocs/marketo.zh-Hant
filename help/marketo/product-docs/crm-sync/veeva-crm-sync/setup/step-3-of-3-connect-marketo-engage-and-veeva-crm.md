---
description: 瞭解如何在最後的設定步驟中將Marketo Engage連結至Veeva CRM。 設定OAuth、確認認證及同步欄位以完成連線。
...
1. 在Marketo中，按一下&#x200B;**[!UICONTROL Admin]**。 選取「**[!UICONTROL CRM]**」然後按一下「**[!UICONTROL Sync with Veeva]**」。
