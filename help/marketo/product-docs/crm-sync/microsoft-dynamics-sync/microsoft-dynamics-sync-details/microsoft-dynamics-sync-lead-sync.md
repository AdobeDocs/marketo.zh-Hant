...
>[!NOTE]
>
>刪除不總是自動在兩個方向同步。 請參 [閱刪除銷售線索或聯繫人](http://docs.marketo.com/x/agO1Ag)。
...
是的，請使用「 [將人員同步至Microsoft](../../../../product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/sync-person-to-microsoft.md) Flow」動作。 如果銷售線索不存在，這將在Dynamics中建立銷售線索。 如果銷售線索存在，流程步驟將不執行任何操作。
...
否，自動化背景同步是同步Marketo和Dynamics之間更新的唯一方式。 「 [將人員同步至Microsoft](../../../../product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/sync-person-to-microsoft.md) 」流程動作不會強制銷售線索同步。
