...
如果您更新Marketo中某個連絡人的「帳戶」欄位，它會變更Marketo中屬於該帳戶的所有連絡人的值。 它不會同步至Dynamics。 不過，下次在Dynamics中更新該帳戶時，變更將會覆寫Marketo中的所有帳戶資訊。
...
大部份是這樣。 但是，如果帳戶有超過5,000個連絡人，且在Dynamics中該帳戶有欄位變更，我們會同步處理變更，但不會記錄5,000多個連絡人的活動。
