...
# Microsoft Dynamics Sync:連絡人同步 {#microsoft-dynamics-sync-contact-sync}
...
否，自動化背景同步是同步Marketo和Dynamics之間更新的唯一方式。 將 [Person同步至Microsoft](../../../../product-docs/core-marketo-concepts/smart-campaigns/microsoft-dynamics-flow-actions/sync-person-to-microsoft.md) ，將不會強制銷售線索同步。
