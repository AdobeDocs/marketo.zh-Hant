...
您在Marketo中為 [!DNL Dynamics][&#128279;](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/microsoft-dynamics-365-with-ropc-connection/step-2-of-4-set-up.md)輸入的認證可用來同步資料。
