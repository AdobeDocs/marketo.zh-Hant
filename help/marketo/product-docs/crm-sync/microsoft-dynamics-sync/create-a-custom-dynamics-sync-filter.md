...
description: 瞭解如何建立自訂Dynamics同步篩選器，以便僅將選取的記錄同步至Marketo。
...
1. 按一下&#x200B;**[!UICONTROL Entities]**&#x200B;旁的![](assets/image2015-8-10-21-3a44-3a23.png)。

   ![](assets/image2015-8-10-21-3a43-3a39.png)

1. 按一下&#x200B;**[!UICONTROL Lead]**&#x200B;旁的![](assets/image2015-8-10-21-3a44-3a23.png)並選取&#x200B;**[!UICONTROL Fields]**。 然後按一下「**[!UICONTROL New]**」。

   ![](assets/image2015-8-10-21-3a49-3a49.png)

1. 在&#x200B;**[!UICONTROL Display Name]**&#x200B;欄位中輸入&#x200B;**SyncToMkto**，並選取&#x200B;**[!UICONTROL Two Options]**&#x200B;做為&#x200B;**[!UICONTROL Data Type]**。 然後按一下「**[!UICONTROL Save and Close]**」。
...
即使初始同步已完成，請前往並選取要與Marketo同步的欄位。
