...
title: 步驟3之3 — 將Microsoft Dynamics與Marketo連線（2011內部部署）
...
# 步驟3之3：將Microsoft Dynamics與Marketo連線（2011內部部署） {#step-of-connect-microsoft-dynamics-with-marketo-on-premises}
...
1. 有預先選取的欄位將進行同步。 您可視需要新增更多，然後按一下 **儲存**.
