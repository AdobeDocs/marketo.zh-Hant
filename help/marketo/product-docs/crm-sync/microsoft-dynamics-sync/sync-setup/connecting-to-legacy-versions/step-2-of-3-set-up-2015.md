...
description: 瞭解如何為Dynamics 2015內部部署設定Marketo同步使用者。 在Dynamics中建立使用者並指派Marketo同步使用者角色。
...
# 步驟3之2：為[!DNL Dynamics]設定Marketo （2015年內部部署）{#step-of-set-up-for-marketo-on-premises-2015}

完成上述步驟的絕佳工作。 讓我們繼續討論這個問題。

>[!PREREQUISITES]
>
>[為 [!DNL Microsoft Dynamics] 2015內部部署第1步（共3步）](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2015.md)安裝Marketo
...
1. 檢查[!UICONTROL Marketo Sync User]並按一下&#x200B;**[!UICONTROL OK]**。
   ...
   >[!TIP]
   >
   >如果您沒有看到角色，請返回3[的](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2015.md){target="_blank"}步驟1並匯入解決方案。
...
>[!MORELIKETHIS]
>
>[為 [!DNL Microsoft Dynamics] 2015內部部署步驟3 / 3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-3-of-3-connect-2015.md)安裝Marketo
