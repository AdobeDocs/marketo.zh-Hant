...
1. 檢查&#x200B;**[!UICONTROL Marketo Sync User]**&#x200B;並按一下&#x200B;**[!UICONTROL 確定]**。
   ...
   >[!TIP]
   >
   >如果您沒有看到角色，請返回3](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2013.md){target="_blank"}的[步驟1並匯入解決方案。
...
1. 在&#x200B;**[!UICONTROL 設定]**&#x200B;下，按一下&#x200B;**[!UICONTROL Marketo設定]**。
   ...
   >[!NOTE]
   >
   >如果缺少「Marketo設定」，請嘗試重新整理頁面。 如果問題仍然存在，請[再次發佈Marketo解決方案](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/connecting-to-legacy-versions/step-1-of-3-install-2013.md)，或嘗試登出再重新登入。
