...
已安裝解決方案並設定同步使用者。 接下來，連線Marketo和[!DNL Dynamics]。
...
現在已設定Marketo與[!DNL Microsoft Dynamics]之間的雙向同步。 如果您已購買[!DNL Marketo Sales Insight]，請參閱下列內容：

>[!MORELIKETHIS]
>
>[在 [!DNL Microsoft Dynamics] 2013](/help/marketo/product-docs/marketo-sales-insight/msi-for-microsoft-dynamics/installing/install-and-configure-marketo-sales-insight-in-microsoft-dynamics-2013.md)中安裝並設定 [!DNL Marketo Sales Insight] 
