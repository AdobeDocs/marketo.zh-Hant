...
description: 瞭解如何在內部部署安裝適用於Dynamics 2015的Marketo解決方案。 在Dynamics中匯入解決方案並完成安裝步驟。
...
您必須先在[!DNL Dynamics]中安裝Marketo解決方案，才能與Marketo同步[!DNL Microsoft Dynamics] 2015內部部署。
