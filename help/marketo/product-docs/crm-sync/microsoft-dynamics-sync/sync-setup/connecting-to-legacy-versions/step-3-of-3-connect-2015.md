...
description: 安裝Marketo for Microsoft Dynamics 2015內部部署步驟3之3 - Marketo檔案 — 產品檔案
title: 安裝Marketo for Microsoft Dynamics 2015內部部署步驟3之3
...
1. 輸入 **[!UICONTROL 使用者名稱]**， **[!UICONTROL 密碼]** Microsoft Dynamics **[!UICONTROL URL]**，和 **使用者端ID/密碼**. 按一下 **[!UICONTROL 儲存]** 完成時。
   ...
   >[!TIP]
   >
   >不知道URL？ 我們將說明如何尋找您的 [動態組織服務URL](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/view-the-organization-service-url.md){target="_blank"} 此處。
