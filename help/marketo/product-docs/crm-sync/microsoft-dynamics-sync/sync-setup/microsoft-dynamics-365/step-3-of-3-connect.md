...
# 步驟3（共3步）:將Microsoft Dynamics與Marketo連結（線上） {#step-of-connect-microsoft-dynamics-with-marketo-online}
...
1. 輸入 **Username**、 **Password**&#x200B;和Microsoft Dynamics **URL** （Client ID和Client Secret為選用）。 完成時 **按一下** 「儲存」。
...
1. 閱讀快顯視窗中的所有內容，輸入您的電子郵件地址，然後按一下「開 **始同步」**。
