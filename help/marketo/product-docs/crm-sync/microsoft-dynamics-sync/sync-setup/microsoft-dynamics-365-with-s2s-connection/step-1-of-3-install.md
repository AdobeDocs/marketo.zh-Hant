---
description: 瞭解如何在Dynamics 365中透過伺服器對伺服器連線安裝Marketo解決方案。 從管理員匯入解決方案並完成安裝步驟。
...
在同步處理[!DNL Microsoft Dynamics 365]與Marketo之前，您必須先在[!DNL Dynamics]中安裝Marketo解決方案。**[!DNL Dynamics]需要管理員許可權。**
