---
description: 安裝適用於Microsoft Dynamics 2016的Marketo/Dynamics 365內部部署1/3 - Marketo檔案 — 產品檔案
title: 安裝適用於Microsoft Dynamics 2016/Dynamics 365內部部署的Marketo步驟3之1
...
>[!PREREQUISITES]
>
>如果您使用Microsoft Dynamics內部部署，則必須設定[網際網路對向部署](https://learn.microsoft.com/en-us/dynamics365/customerengagement/on-premises/deploy/configure-an-internet-facing-deployment){target="_blank"} (IFD)及[Active Directory Federation Services](https://msdn.microsoft.com/en-us/library/bb897402.aspx){target="_blank"} 2.0+ (ADFS)。 附註：當您按一下連結時，IFD檔案會自動下載。
>
...
1. 按一下&#x200B;**[!UICONTROL Browse]**&#x200B;並選取您[下載的解決方案](/help/marketo/product-docs/crm-sync/microsoft-dynamics-sync/sync-setup/download-the-marketo-lead-management-solution.md){target="_blank"}。 按一下&#x200B;**下一步**。
