---
description: 第2步（共4步） — 使用資源擁有者密碼控制連線設定Marketo解決方案 — Marketo檔案 — 產品檔案
title: 第2步（共4步） — 使用資源擁有者密碼控制連線設定Marketo解決方案
...
# 第2步，共4步：使用資源擁有者密碼控制連線設定Marketo解決方案 {#step-2-of-4-set-up-the-marketo-solution-ropc}
