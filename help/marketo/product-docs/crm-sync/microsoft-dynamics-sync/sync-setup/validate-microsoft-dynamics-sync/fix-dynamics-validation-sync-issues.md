...
如果您這裡有![x](assets/delete.png)，請確認已在Microsoft Dynamics的Marketo預設頁面上指派同步使用者。
...
如果您這裡有![x](assets/delete.png)，請在Microsoft Dynamics的Marketo設定預設設定步驟的Marketo使用者欄位中，指派適當的同步使用者。
