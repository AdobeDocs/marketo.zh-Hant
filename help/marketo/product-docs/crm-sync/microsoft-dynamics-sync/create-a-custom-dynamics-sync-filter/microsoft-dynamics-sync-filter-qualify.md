...
description: 瞭解將銷售機會轉換為聯絡人時，Dynamics同步篩選器的「符合資格」程式。 瞭解銷售機會和連絡人同步處理篩選值如何影響Marketo同步處理。
...
當您想要在[!DNL Microsoft Dynamics]中將銷售機會轉換為聯絡人時，請使用此預設的資格程式。 然後，將其同步至Marketo。
