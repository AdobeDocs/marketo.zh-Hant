...
否，Marketo僅支援一種貨幣。 機會金額將從[!DNL Salesforce]同步，但貨幣將是您Marketo訂閱中的[預設貨幣](/help/marketo/product-docs/administration/settings/set-default-currency.md)。
...
您可以在[人員詳細資料](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/using-the-person-detail-page.md)頁面的&#x200B;**[!UICONTROL Opportunity Info]**&#x200B;索引標籤中檢視商機清單。
...
>[!TIP]
>
>如需其他詳細資訊，請檢閱篩選器和觸發器的限制。
>
>在[!DNL Salesforce]的機會物件中建立新欄位，它會自動變成限制！
