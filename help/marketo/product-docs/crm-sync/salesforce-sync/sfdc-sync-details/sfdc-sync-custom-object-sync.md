...
# SFDC 同步：自訂物件同步 {#sfdc-sync-custom-object-sync}
...
>[!PREREQUISITES]
>
>若要使用自訂物件，它必須關聯至[!DNL Salesforce]中的[銷售機會](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-field-sync.md)、[連絡人](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-contact-sync.md)或[帳戶](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-sync-account-sync.md)物件。
...
[新增/移除自訂物件欄位做為智慧清單/觸發程序限制](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/optional-steps/add-remove-custom-object-field-as-smart-list-trigger-constraints.md){target="_blank"}

您現在可以在智慧行銷活動和智慧清單中使用來自此自訂物件的資料。
