...
想像一下Salesforce中的三種不同情況：(不使用 [轉換人員流程步驟](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/convert-person.md) (在Marketo中)
...
您可以使用以下專案來觸發及篩選：「已轉換銷售機會」及「已轉換銷售機會」。
