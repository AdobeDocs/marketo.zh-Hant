...
1. 在導覽搜尋列中輸入&quot;[!UICONTROL page layouts]&quot;而不按&#x200B;**[!UICONTROL Enter]**，然後按一下&#x200B;**[!UICONTROL Leads]**&#x200B;底下的&#x200B;**[!UICONTROL Page Layout]**。
...
1. 完成&#x200B;**[!UICONTROL Contact Page Layout]**&#x200B;時，請記得按一下&#x200B;**[!UICONTROL Save]**。
...
現在您已擁有Marketo可用來連線至[!DNL Salesforce]的帳戶。
