...
# 步驟1（共3步）:將行銷人員欄位新增至Salesforce（企業／無限制）{#step-of-add-marketo-fields-to-salesforce-enterprise-unlimited}
...
1. 在左邊的「構建」菜單中，按一下「定制」並選擇「銷售線索」。 按一下欄位。
...
1. 指定存取設定，然後按一下「下一步」:
   ...
   * 清除同步用戶配置檔案的&#x200B;**只讀**&#x200B;複選框：
      ...
      * 如果用戶的配置檔案為&#x200B;*系統管理員*&#x200B;作為同步用戶，請清除系統管理員配置檔案的&#x200B;**只讀**&#x200B;複選框（如下所示）
      * 如果為同步用戶建立了&#x200B;*自定義配置檔案*，請清除該自定義配置檔案的&#x200B;**只讀**&#x200B;複選框
...
1. 按一下「儲存並新增」返回並建立其他兩個自訂欄位。 按一下「儲存」，您就完成這三項作業。

   ![](assets/image2016-5-23-15-3a8-3a43.png)

1. 在左側的「構建」菜單中，按一下「定制」並選擇「聯繫人」。 按一下欄位。
