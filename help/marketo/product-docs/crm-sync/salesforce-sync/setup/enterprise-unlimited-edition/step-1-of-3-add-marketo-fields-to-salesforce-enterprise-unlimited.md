...
description: 步驟1/3 — 將Marketo欄位新增至Salesforce (Enterprise/Unlimited) - Marketo檔案 — 產品檔案
title: 步驟1/3 — 將Marketo欄位新增至Salesforce (Enterprise/Unlimited)
...
# 步驟1/3：將Marketo欄位新增至Salesforce (Enterprise/Unlimited) {#step-of-add-marketo-fields-to-salesforce-enterprise-unlimited}
...
1. 在Nav Search中輸入「Fields」，而不按Enter。 欄位會顯示在不同的物件下；按一下 **欄位** 在潛在客戶底下。
