...
# 步驟3之1：將Marketo欄位新增至[!DNL Salesforce] (Enterprise/Unlimited) {#step-of-add-marketo-fields-to-salesforce-enterprise-unlimited}

>[!PREREQUISITES]
>
>您必須有權存取[!DNL Salesforce] API，才能在Marketo和[!DNL Salesforce]之間同步。
...
1. 登入[!DNL Salesforce]並按一下&#x200B;**[!UICONTROL Setup]**。
...
1. 在左側的[組建]功能表中，按一下&#x200B;**[!UICONTROL Customize]**&#x200B;並選取[連絡人]。 按一下「[!UICONTROL Fields]」。
...
1. 移至[!UICONTROL Lead Custom Fields & Relationships]區段並按一下&#x200B;**[!UICONTROL Map Lead Fields]**。
