...
1. 在導覽搜尋中輸入「欄位」，不按Enter鍵。 欄位會顯示在不同的物件下；按一下 **Leads下的** Fields。

   ![](assets/image2016-5-26-16-3a36-3a32.png)

1. 轉至「銷售線索自訂欄位與關係」區段，然後按一下「對 **應銷售線索欄位」**。
...
>**深入探討**
>
>這裡有一段視頻， [其中說明了整個程式](https://nation.marketo.com/videos/1475) ，應該非常清楚！
