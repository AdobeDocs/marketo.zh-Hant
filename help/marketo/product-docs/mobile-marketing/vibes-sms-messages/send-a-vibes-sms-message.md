---
description: 傳送Vibes SMS訊息 — Marketo檔案 — 產品檔案
title: 傳送Vibes SMS訊息
hide: true
hidefromtoc: true
...
# 傳送Vibes SMS訊息 {#send-a-vibes-sms-message}

您已 [已建立您的Vibes SMS訊息](/help/marketo/product-docs/mobile-marketing/vibes-sms-messages/create-a-vibes-sms-message.md)，現在該傳送它了。 您可以透過批次或觸發行銷活動來傳送。
