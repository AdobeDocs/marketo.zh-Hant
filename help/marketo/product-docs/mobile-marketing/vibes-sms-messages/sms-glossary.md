...
<tbody>
  ...
  <tr>
    <td>自訂短網域</td>
    <td>如果您使用Vibes連結縮短程式，縮短的URL預設會顯示在Vibes短URL： https://vbs.cm/xxxxxx底下。 自訂簡短網域是您的品牌專屬的網域。 <a href="https://developer-platform.vibes.com/docs/creating-a-custom-short-domain">進一步瞭解自訂短網域</a>。<p>
