...
在您之後 [建立Vibes SMS訊息](/help/marketo/product-docs/mobile-marketing/vibes-sms-messages/create-a-vibes-sms-message.md)，您會想要在智慧行銷活動中使用智慧列示觸發器和篩選器，以獲得好處。 方法如下。

1. 在「我的Marketo」中，按一下 **行銷活動**.

   ![](assets/image2016-7-28-9-3a48-3a32.png)

1. 選擇您要使用簡訊資產的智慧型行銷活動。 拖曳到觸發器上，例如熱門的 **填寫表單**.

   ![](assets/fills-out-form-pull-over.jpg)

## 簡訊觸發程式 {#sms-triggers}

有其他可用的簡訊觸發程式。 SMS觸發程式僅在啟用Vibes服務時出現。

![](assets/new-sms-search2.png)

以下是一些範例：

SMS訊息跳出觸發程式會在SMS訊息跳出時起始流程，例如傳送電子郵件。
...
此 **SMS訊息中的點按連結** 當有人點選SMS訊息中的連結時，觸發器就會起始流量。

![](assets/clicks-link-in-sms-message.jpg)

## 簡訊篩選器 {#sms-filters}

您也可以在智慧清單中使用Vibes篩選器。 此 **已訂閱的Vibes清單** 篩選器會尋找有以下情況的任何人： *永遠* 已訂閱Vibes。 這包括已取消訂閱和已刪除的人員，即使已刪除的人員已從流量中忽略。 此篩選器最適合用於報表。

![](assets/subscribed-to-vibes-list-filter-real.jpg)

相較之下， **Vibes清單的成員** 篩選尋找 _任何人_ 目前已訂閱Vibes，最適合用於智慧行銷活動或清單。
