...
description: 瞭解如何設定應用程式內訊息背景。 選擇顏色或影像、設定邊框和圓角半徑，並為每個平台設定點選動作。
title: 設定應用程式內訊息背景
...
1. 若要設定顏色，請按一下&#x200B;**[!UICONTROL Color]**，然後按顏色選取方塊。 按一下顏色，或在檢色器上輸入十六進位或RGB程式碼以選取顏色。
...
1. 若要使用背景，請按一下&#x200B;**[!UICONTROL Image]**，然後按一下&#x200B;**[!UICONTROL Select Image]**&#x200B;連結。

   ![](assets/image2016-5-9-8-3a52-3a43.png)

1. 從上傳至Design Studio的檔案中進行選擇。 按一下「**[!UICONTROL Select]**」。
...
1. 套用選用的影像邊框。 預設設定為&#x200B;**[!UICONTROL Off]**。 首先，按一下顏色或在檢色器上輸入十六進位或RGB數字來選取顏色。
...
1. 核取方塊以設定背景點選動作（預設為關閉）。
   ...
   >[!NOTE]
   >
   >如需背景的點選動作，您可以為Apple和Android平台設定不同的動作。 例如，Apple和Android的深層連結處理方式不同。 如果您的訊息只傳送到其中一個平台，請將另一個平台保留為預設設定，或選取&#x200B;**[!UICONTROL None]**。
