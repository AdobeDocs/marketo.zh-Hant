...
1. 按一下按鈕以開啟[!UICONTROL Style]標籤進行編輯。

   ![](assets/image2016-5-6-15-3a6-3a55.png)

1. 若要變更標準按鈕的顏色，請按一下&#x200B;**[!UICONTROL Color]**&#x200B;按鈕。

   ![](assets/image2016-5-6-15-3a10-3a38.png)

1. 按一下顏色選取方塊，然後按一下按鈕顏色，或在檢色器上輸入十六進位或RGB數字來選取按鈕顏色。
...
1. 如果您想要將自己的影像用於按鈕，請按一下&#x200B;**[!UICONTROL Image]**&#x200B;按鈕，然後按一下&#x200B;**[!UICONTROL Select Image]**。

   ![](assets/image2016-5-6-15-3a18-3a18.png)

1. 選擇影像並按一下&#x200B;**[!UICONTROL Select]**。
...
1. 按一下顏色選取方塊，然後按一下字型顏色，或在檢色器上輸入十六進位或RGB數字來選取字型顏色。
...
1. 按一下每個平台的下拉式清單，然後選取點選動作。
   ...
   >[!NOTE]
   >
   >按鈕一律會有點選動作，因此「點選動作」核取方塊會自動選取，且預設訊息為&quot;[!UICONTROL Dismiss Message]&quot;。
...
>* [選擇您[!UICONTROL In-App Message]](/help/marketo/product-docs/mobile-marketing/in-app-messages/creating-in-app-messages/choose-a-layout-for-your-in-app-message.md)的配置
