...
1. 在「推送存取類型」下，選取iOS，然後按一下「設定」。
   ...
   >[!NOTE]
   >
   >您將需要行動應 **用程式開** 發人 **員提供的** 「認證」和「密碼」。 開發人員可登入Apple Developer會員中心、設定並下載您應用程式的推播通知憑證，以及匯出內容，以接收這些資訊。 開發人員在進行匯出時設定密碼。 **重要**:該證書應適合您使用的環境類型— 沙盒或生產。 請洽詢您的行銷人員或行動應用程式開發人員，以驗證此點。
