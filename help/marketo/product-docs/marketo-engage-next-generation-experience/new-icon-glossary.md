---
description: 新圖示辭彙表-Marketo文檔——產品文檔
title: 新圖示辭彙表
...
# 新圖示辭彙表{#new-icon-glossary}

以下是新AdobeMarketo Engage介面的所有新表徵圖。 如果您仍在運行Marketo Classic，您的表徵圖辭彙表可以是[，可在此處找到](/help/marketo/getting-started/icon-glossary.md)。
