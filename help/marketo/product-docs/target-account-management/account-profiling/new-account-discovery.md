...
新帳戶探索可利用理想客戶設定檔中的AI支援建議，協助您尋找要鎖定的新帳戶。
...
>[!TIP]
>
>建議按下 **更新現有帳戶** 按鈕之前，用來搜尋新帳戶，以確保您檢視的是最新資料。 此更新最多可能需要24小時的時間。
...
1. 您可以建立清單自己的新帳戶清單，或將其新增至現有帳戶清單。 在此範例中，我們將建立一個新的。

   ![](assets/six-1.png)

   >[!NOTE]
   >
   >若要將其儲存至現有的帳戶清單，請選取該選項，按一下下拉式清單並選取所需的帳戶清單，然後按一下 **下一個**.
