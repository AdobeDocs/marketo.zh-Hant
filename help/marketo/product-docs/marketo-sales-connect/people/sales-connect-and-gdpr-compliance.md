...
description: 瞭解Sales Connect和GDPR法規遵循。 瞭解Sales Connect如何支援資料隱私權和同意要求。
title: Sales Connect 和 GDPR 合規性
...
如果為[!UICONTROL Authorization Type]或[!UICONTROL Source Type]選擇「[!UICONTROL Other]」，您可以輸入描述Source型別的文字。
