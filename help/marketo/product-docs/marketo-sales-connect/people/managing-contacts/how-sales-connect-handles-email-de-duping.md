...
當您[上傳CSV](/help/marketo/product-docs/marketo-sales-connect/people/managing-contacts/import-contacts-via-csv.md)檔案至Sales Connect時，我們會先合併CSV中的所有類似連絡人，再進行匯入。
