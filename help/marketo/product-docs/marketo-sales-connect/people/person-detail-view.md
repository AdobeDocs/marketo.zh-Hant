...
1. 按一下所需人員。
   ...
   >[!TIP]
   >
   >幾乎任何看到個人名稱的地方，都可以按一下並進入其「個人詳細資料檢視」。
...
* 編輯或刪除任務
* 檢視到期日期
* 按一下「型別」以啟動「銷售電話（如果通話）」、「電子郵件撰寫（如果電子郵件）」、「Linkedin（如果是Inmail）」和「自訂附註（如果是「自訂」）」。
* 將任務標示為完成
