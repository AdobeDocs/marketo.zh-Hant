...
>[!TIP]
>
>「first_name」和「company」欄位是唯一會同時尋找Sales Connect和Salesforce的欄位。 這表示如果連絡人不存在於 [網頁應用程式](https://toutapp.com/login)，我們會檢視Salesforce，看看是否能找到具有相符電子郵件地址的聯絡人/潛在客戶記錄。 然後我們會使用該記錄中的資訊來填入欄位。
...
1. 按一下 **Tout動態欄位**.
   ...
   >[!NOTE]
   >
   >以電子郵件傳送存在於Sales Connect中的連絡人時，您可以使用基本動態欄位。 這些會直接從連絡人提取。
