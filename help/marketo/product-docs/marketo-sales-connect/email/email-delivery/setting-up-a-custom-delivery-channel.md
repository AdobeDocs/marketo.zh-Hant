...
>[!NOTE]
>
>* 除了設定SMTP伺服器之外， [必須驗證電子郵件身分](/help/marketo/product-docs/marketo-sales-connect/getting-started/email-settings/verify-your-email.md) 再傳送電子郵件。
...
1. 在[電子郵件設定]中按一下 **地址和簽名**.

   ![](assets/setting-up-a-custom-delivery-channel-5.png)

1. 尋找您要選擇傳送頻道的電子郵件身分識別，然後按一下 **選擇傳遞頻道**.
