...
description: 瞭解Sales Connect中的電子郵件欄和電子郵件頁面配置。 自訂哪些欄會顯示在「命令中心」和電子郵件檢視中。
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>[!DNL Sales Connect]中人員的姓名和電子郵件。 按一下此欄位將會開啟人員詳細資料檢視中的「關於」標籤。</td>
  </tr>
  <tr>
   <td>[!UICONTROL Name]</td>
   <td>[!DNL Sales Connect]中的人員名稱。</td>
  </tr>
  <tr>
   <td>[!UICONTROL Address]</td>
   <td>[!DNL Sales Connect]中人員的主要電子郵件地址。</td>
  </tr>
  <tr>
