...
* 電子郵件傳遞頻道：依預設，您的電子郵件會透過ToutApp伺服器傳送。 藉由設定您自己的Gmail或自訂SMTP，您可以讓電子郵件有最佳的機會進入收件者的收件匣。 [按一下這裡](https://nation.marketo.com/docs/DOC-5080){target="_blank"}以閱讀更多有關根據您的需求選擇正確傳遞管道的資訊。
