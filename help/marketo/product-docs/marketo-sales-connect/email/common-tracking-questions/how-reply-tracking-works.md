...
>[!PREREQUISITES]
>
>**與電子郵件伺服器的連線：** Sales Connect必須連線到您的收件匣，以便我們知道何時收到新的回覆。 您必須將您的Sales Connect帳戶[連線至Gmail](/help/marketo/product-docs/marketo-sales-connect/email-plugins/gmail/email-connection-for-gmail-users.md)。 如果您正在使用Outlook，則需要與您的[Exchange伺服器](https://toutapp.com/next#settings/exchange_settings)整合。
