...
description: 銷售連線中的有趣時刻 — Marketo檔案 — 產品檔案
...
通過Marketo Sales Connect與您的銷售團隊溝通的關鍵時刻是有趣的時刻。
...
## Sales Connect中的有趣時刻是什麼？ {#what-does-an-interesting-moment-look-like-in-sales-connect}
