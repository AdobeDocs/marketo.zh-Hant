...
# 快速入門影片和教學課程{#quick-start-videos-and-tutorials}

>[!NOTE]
>
>Marketo Sales Engage最近更名為Marketo Sales Connect。 我們正在更新所有視訊，但有些視訊仍會顯示舊名。

## 啟用行銷洞察{#enabling-marketing-insights}
...
## 電子郵件設定概觀{#email-settings-overview}
...
## 在Salesforce {#installing-customizations-in-salesforce}中安裝自訂
...
## Salesforce概觀{#salesforce-overview}
