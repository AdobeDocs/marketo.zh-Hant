...
description: 瞭解如何安裝Professional Edition的Sales Connect Salesforce自訂功能。 設定使用Salesforce PE時的自訂專案。
...
1. 按一下&#x200B;**[!UICONTROL Setup]**，在搜尋列中搜尋「已安裝的封裝」，然後按一下&#x200B;**[!UICONTROL Installed Packages]**。
   ...
   若要在[!DNL Salesforce]執行個體中設定[!DNL Sales Connect]，請依照《安裝指南》第7頁的「設定SALES ENGAGE SALESFORCE套件」一節中所述的步驟操作。
