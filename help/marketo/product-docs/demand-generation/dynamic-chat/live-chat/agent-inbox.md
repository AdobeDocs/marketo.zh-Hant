...
由產生式AI [回應程式庫](/help/marketo/product-docs/demand-generation/dynamic-chat/generative-ai/response-library.md)支援的捷徑，是取得與訪客聊天時說明的有效方式。 在文字方塊中輸入正斜線(`/`)，然後選擇`ask`或`search`。
