...
1. 登入Admin Console後，下一步要做的就是新增使用者。 我們將處理程式[記錄在此處](/help/marketo/product-docs/demand-generation/dynamic-chat/setup-and-configuration/add-or-remove-chat-users.md#add-a-chat-user){target="_blank"}。
