...
>[!IMPORTANT]
>
>按照這些步驟操作，並在第一個Marketo表單[&#128279;](/help/marketo/product-docs/demand-generation/forms/using-captcha/enable-captcha-in-marketo-forms.md){target="_blank"}中啟用驗證碼後，立即測試表單，因為reCAPTCHA設定中的任何錯誤設定都會破壞表單。
