...
description: 瞭解如何在Marketo中設定表單感謝頁面。 在提交者提交表單後，將其傳送至特定頁面或URL。
title: 設定表單感謝頁面
...
1. 為&#x200B;**[!UICONTROL Follow Up With]**&#x200B;選取&#x200B;**[!UICONTROL Stay On Page]**。
...
1. 為&#x200B;**[!UICONTROL Follow Up With]**&#x200B;選取&#x200B;**[!UICONTROL External URL]**。
