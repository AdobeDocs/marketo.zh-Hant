...
description: 瞭解如何在Marketo中核准表單。 核准您的表單，以便用於登陸頁面並開始擷取潛在客戶。
title: 核准表單
...
1. 選取所需的表單並按一下&#x200B;**[!UICONTROL Approve draft]**。
   ...
   已核准並準備好[新增至登陸頁面](/help/marketo/product-docs/demand-generation/landing-pages/understanding-landing-pages/approve-unapprove-or-delete-a-landing-page.md){target="_blank"}。
