...
>[!NOTE]
>
>引數有點技術化，不是嗎？ 不過一旦您取得，就表示它們是強大的。 這個 [查詢字串上的Wikipedia頁面](https://en.wikipedia.org/wiki/Query_string) 會有所幫助。
...
如果您想要在填寫表單前從訪客來自的頁面擷取資料，您可使用 **反向連結引數**.

1. 設定 **值取得來源** 至 **反向連結引數**.

   ![](assets/image2014-9-15-13-3a9-3a31.png)

1. 輸入 **引數名稱** 您想從反向連結URL擷取並按一下 **儲存**.

   ![](assets/image2014-9-15-13-3a9-3a56.png)

   >[!TIP]
   >
   >您可以輸入 **預設值** 在找不到反向連結引數的情況下使用。
