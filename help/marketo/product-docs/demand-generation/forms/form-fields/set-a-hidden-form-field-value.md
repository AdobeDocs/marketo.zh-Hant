...
>[!NOTE]
>
>參數有點技術化，不是嗎？ 但一旦你得到了它們，它們就變得強大了。 查詢字串上的此[Wikipedia頁面](https://en.wikipedia.org/wiki/Query_string)有些幫助。
...
如果您將資料儲存在Cookie中，則可在提交表單時使用&#x200B;**Cookie值**&#x200B;來擷取資料。
...
如果您想在填寫表單前從訪客來自的頁面擷取資料，可使用&#x200B;**反向連結參數**。

1. 將&#x200B;**Get Value From**&#x200B;設為&#x200B;**Referrer Parameter**。
