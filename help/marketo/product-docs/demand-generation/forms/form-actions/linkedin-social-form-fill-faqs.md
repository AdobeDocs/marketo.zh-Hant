...
description: 取得LinkedIn社交表單填入Marketo表單的相關說明。 尋找有關LinkedIn表單填寫整合的常見問題解答。
title: LinkedIn 社交表單填寫常見問題集
hide: true
...
>[!NOTE]
>
>以上影像僅供範例使用。 這可能與您的社交表單填寫按鈕容器的呈現方式不完全相同。 您選擇的任何字型顏色、樣式等都會影響容器的外觀。
