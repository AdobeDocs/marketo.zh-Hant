...
1. 按一下清單底部的&#x200B;**[!UICONTROL Send Via Ad Bridge]**&#x200B;圖示![—](assets/icon-ad-bridge.png)。
...
1. 選取&#x200B;**[!UICONTROL LinkedIn Audience]**。
...
1. 選取&#x200B;**[!UICONTROL Push Type]**。 按一下「**[!UICONTROL Update]**」。
...
您的資料現在會與LinkedIn的對象同步。 如需上傳清單至LinkedIn以鎖定帳戶和連絡人目標的相關資訊，請造訪[LinkedIn的行銷解決方案說明中心](https://www.linkedin.com/help/lms/answer/73938?query=ad%20segment){target="_blank"}。
