...
1. 輸入&#x200B;**[!UICONTROL Display Name]**&#x200B;並從&#x200B;**[!UICONTROL Service]**&#x200B;下拉式清單中選取&#x200B;**[!UICONTROL Google Customer Match]**。 按一下「**[!UICONTROL Create]**」。
...
1. 您的[!DNL Google AdWords]帳戶現在已連線至Marketo。 按一下「**[!UICONTROL Create]**」。
   ...
   「Google相符的對象」現在在「已安裝服務」標籤中列為[!DNL LaunchPoint]服務。
