...
透過這項整合，您可以從Marketo靜態與智慧列示傳送對象資料至[!DNL Facebook]，以在[!DNL Facebook]廣告行銷活動中作為自訂對象使用。 請依照下列步驟進行設定。
...
1. 輸入您服務的&#x200B;**[!UICONTROL Display Name]**，然後從&#x200B;**[!UICONTROL Service]**&#x200B;下拉式清單中選取&#x200B;**[!UICONTROL Facebook Custom Audiences]**&#x200B;服務。
...
1. 您現在已獲得授權！ 選取相符模式並按一下&#x200B;**[!UICONTROL Create]**。
   ...
   您現在可以前往Marketo中的任何靜態或智慧清單，並將對象資料傳送至[!DNL Facebook]。

   >[!CAUTION]
   >
   >使用整合前，請在您的[!DNL Facebook]帳戶中[接受 [!DNL Facebook]的自訂對象條款](https://www.facebook.com/ads/manage/customaudiences/tos.php)！ 若未這麼做，對象更新將會失敗。
