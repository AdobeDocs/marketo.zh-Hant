...
透過這項整合，您可以從Marketo靜態和智慧清單將對象資料傳送到Facebook，用作Facebook廣告促銷活動中的自訂對象。 以下說明設定方法。
...
1. 輸入 **顯示名稱** ，並選取 **facebook自訂對象** 來自的服務 **服務** 下拉式清單。
...
1. 您現在已獲得授權！ 選取相符模式並按一下 **建立**.
   ...
   >[!CAUTION]
   >
   >噢，開始之前，請務必 [接受Facebook的自訂對象條款](https://www.facebook.com/ads/manage/customaudiences/tos.php) 在您的Facebook帳戶內！ 若未這麼做，對象更新將會失敗。
