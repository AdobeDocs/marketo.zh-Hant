...
description: 測試案頭整合Marketo的Facebook銷售機會廣告 — Marketo檔案 — 產品檔案
title: 測試案頭與Marketo整合的Facebook銷售機會廣告
...
# 測試案頭與Marketo整合的Facebook銷售機會廣告 {#test-facebook-lead-ads-for-desktop-integration-with-marketo}
...
1. 您將在瀏覽器的新標籤中被導向到Facebook。 按一下Facebook銷售機會廣告單位中的「行動號召」 。
