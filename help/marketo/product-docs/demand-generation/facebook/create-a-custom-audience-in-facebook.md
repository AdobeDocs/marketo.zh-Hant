...
>[!TIP]
>
>深入了解 [facebook中的自訂對象](https://www.facebook.com/help/341425252616329).
...
1. 完成後，狀態對話方塊將會更新。
   ...
   >[!TIP]
   >
   >請參閱 [FacebookMarketo客戶的學習路徑](https://facebook.exceedlms.com/student/enrollments/create_enrollment_from_token/BF9TqSaCvM73PP4ScjhCm4fi). 涵蓋您需要知道的所有事項，從建立Facebook頁面，到使用Marketo的廣告網路整合來鎖定Facebook廣告。
