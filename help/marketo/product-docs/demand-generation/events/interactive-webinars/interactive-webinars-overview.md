...
>[!IMPORTANT]
>
>由Adobe Connect提供支援的互動式網路研討會，是一項與Adobe Connect內建整合的功能。 您對互動式網路研討會的使用將受其他條款與條件的限制。 請檢閱您的合約，或[聯絡Adobe](https://nation.marketo.com/t5/support/ct-p/Support){target="_blank"}以查詢其他條款與條件。
...
**我已用完所包含的互動式網路研討會數目。 如何取得更多工作階段或更大的容量？**
...
**我是否需要將Adobe Connect支援的網路研討會與互動式網路研討會活動程式建立關聯，例如與Launchpoint活動程式建立關聯？**

否，互動式網路研討會活動程式會為您建立關聯。

**為什麼我的部分潛在客戶有「註冊錯誤」狀態而非「已註冊」？**
...
但事實並非如此。 您的網路研討會開始後，按一下網路研討會名稱旁的下拉式清單，並選取&#x200B;**錄製工作階段**。
