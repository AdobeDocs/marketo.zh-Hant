...
**步驟一**： [新增使用者](/help/marketo/product-docs/demand-generation/events/interactive-webinars/user-and-license-management.md#add-a-user){target="_blank"}。 瞭解如何新增（以及稍後視需要移除）使用者，以取得互動式網路研討會存取權。

**步驟二**： [建立互動式網路研討會](/help/marketo/product-docs/demand-generation/events/interactive-webinars/create-an-interactive-webinar.md){target="_blank"}{target="_blank"}。 瞭解如何建立事件計畫並設定網路研討會的初始引數。

**步驟三（選用）**： [新增網路研討會團隊](/help/marketo/product-docs/demand-generation/events/interactive-webinars/add-a-webinar-team.md){target="_blank"}{target="_blank"}。 如果您不打算自行主持網路研討會，請瞭解如何新增主持人和共同主持人，以共用主控/簡報職責。

**步驟四**：[設計您的互動式網路研討會](/help/marketo/product-docs/demand-generation/events/interactive-webinars/designing-interactive-webinars.md){target="_blank"}。 在建立網路研討會並新增選用團隊後，是時候量身打造事件以符合您的特定需求了。
