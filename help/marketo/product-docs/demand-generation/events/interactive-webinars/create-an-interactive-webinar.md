---
description: 瞭解如何在Marketo中建立互動式網路研討會。 請依照步驟設定您的網路研討會，並設定即時或隨選傳送的設定。
title: 建立互動式網路研討會
...
1. 按一下「頻道」下拉式清單，然後選取在其「套用至」欄中具有&#x200B;_具有網路研討會_&#x200B;之事件的任何頻道。 在此範例中，已選取&#x200B;**網路研討會**。
...
1. 為您的網路研討會指定標題，並決定持續時間。
   ...
   >[!NOTE]
   >
   >* 網路研討會標題&#x200B;**在參與者加入時可看到**。 標題必須與您Marketo Engage例項中的互動式網路研討會事件計畫名稱，以及網路研討會聊天室名稱不同，這一點很重要。
   >
...
現在是[設計您的網路研討會](/help/marketo/product-docs/demand-generation/events/interactive-webinars/designing-interactive-webinars.md){target="_blank"}的時候了。
