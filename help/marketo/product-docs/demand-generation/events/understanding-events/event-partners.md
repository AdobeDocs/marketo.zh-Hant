...
description: 活動合作夥伴 — Marketo文檔 — 產品文檔
title: 活動合作夥伴
...
將Marketo連接到活動合作夥伴以自動執行您的線上事件。 當連接它們時，您可以：

* 管理網路研討會活動
* 將在Marketo登錄頁上捕獲的註冊資訊推送到已配置的事件合作夥伴
* 自動將考勤資訊納入Marketo活動
* 捕獲作為程式成員的人員的狀態

請參閱有關將您的線上Marketo事件與您的活動合作夥伴整合的說明：

* [韋貝](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-webex.md)
...
* [就緒](/help/marketo/product-docs/demand-generation/events/create-an-event/create-an-event-with-readytalk.md)
