...
首先，確認您已在Adobe Connect中建立會議或研討會。 如需協助，請參閱[Adobe Connect使用手冊](https://help.adobe.com/en_US/connect/9.0/using/index.html)。

您在Adobe Connect中建立的會議和研討會，必須在您在Marketo中輸入認證時指定的資料夾下建立。 建立會議或研討會後，記下任何相關的後勤資訊（例如電話號碼），以便用於確認電子郵件和ICS檔案。

>[!CAUTION]
>
>作為活動主持人，從應用程式內加入，並且&#x200B;**不**&#x200B;透過傳送給出席者的連結。
...
1. 在新事件的首頁上，選取&#x200B;**[!UICONTROL Event Actions]**，然後選取&#x200B;**[!UICONTROL Event Settings]**。
   ...
   >[!NOTE]
   >
   >如果您在下拉式清單中看不到&#x200B;**[!UICONTROL Event Settings]**，請確認事件的頻道已在「[!UICONTROL Applies to]」下選取&#x200B;**[!UICONTROL Event with Webinar]**。
...
1. 按一下「**[!UICONTROL Save]**」。
   ...
   您的Adobe Connect事件現在已與您的Marketo事件同步。
