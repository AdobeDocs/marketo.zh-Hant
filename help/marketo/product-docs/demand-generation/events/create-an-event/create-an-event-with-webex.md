...
* **網路研討會密碼**： （選擇性）如果您使用此欄位，請將其加入您的確認電子郵件中。
* **小組成員密碼**： （選擇性）如果您使用此欄位，請將其加入您的網路研討會議程。
...
>[!NOTE]
>
>Marketo-Webex整合無法支援從Webex傳送確認電子郵件。 必須透過Marketo傳送確認。 排程活動後，將活動資訊複製到Marketo確認電子郵件，並將電子郵件設為&#x200B;_營運_。
...
您的Webex事件現在已與Marketo事件程式同步。 當新狀態設為「已註冊」時，報名參加網路研討會的人員將透過&#x200B;_變更方案狀態_&#x200B;流程步驟推送至您的網路研討會提供者。 沒有其他狀態會將人員推到。 進行&#x200B;_變更方案狀態_&#x200B;流程步驟#1和&#x200B;_傳送電子郵件_&#x200B;流程步驟#2。
