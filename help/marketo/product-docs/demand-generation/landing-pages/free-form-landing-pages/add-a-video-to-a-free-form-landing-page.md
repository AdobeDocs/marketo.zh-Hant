...
description: 瞭解如何在Marketo中將影片新增至自由格式的登陸頁面。 將視訊內容內嵌至您的登陸頁面。
title: 新增影片至自由格式登陸頁面
...
1. 從右側的元素拖曳到&#x200B;**[!UICONTROL Video]**&#x200B;上方。
...
1. 從下拉式功能表中選取&#x200B;**[!UICONTROL Create New]**。
   ...
   >[!NOTE]
   >
   >**[!UICONTROL Create New]**&#x200B;功能僅在[!UICONTROL Marketing Activities]中顯示；在[!UICONTROL Design Studio]中無法使用。 Design Studio中僅提供已建立的視訊。 不過，您可以選取&#x200B;_>_，在程式&#x200B;**[!UICONTROL New]**&#x200B;內建立視訊共用&#x200B;**[!UICONTROL New Local Asset]**。 然後，您可以從下拉式清單中選取它，如下所示。

1. 輸入YouTube影片的URL，然後為您的影片命名。 在&#x200B;**[!UICONTROL Clone From]**&#x200B;下拉式清單中選取&#x200B;**[!UICONTROL None]**，然後按一下&#x200B;**[!UICONTROL Insert]**。
