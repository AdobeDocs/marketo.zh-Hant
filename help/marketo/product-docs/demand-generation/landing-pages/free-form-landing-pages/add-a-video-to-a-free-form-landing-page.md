...
1. 從下拉式功能表中選取&#x200B;**新建**。
   ...
   >[!NOTE]
   >
   >**建立新**&#x200B;功能只出現在行銷活動中；在Design Studio中無法使用。 Design Studio中僅提供已建立的視訊。 不過，您可以選取&#x200B;**新增** > **新增本機資產**，以在程式&#x200B;_內建立視訊共用_。 然後，您可以從下拉式清單中選取它，如下所示。

1. 輸入YouTube影片的URL，然後為您的影片命名。 在「複製來源」下拉式清單中，選取&#x200B;**無**，然後按一下&#x200B;**插入**。
