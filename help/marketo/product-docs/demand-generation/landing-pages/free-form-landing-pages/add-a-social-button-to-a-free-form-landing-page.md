...
1. 選取 **社交按鈕（含Analytics）**.
   ...
   一旦您的登入頁面作用中，請在以下連結上檢視您的社交按鈕（透過Analytics）產生的活動： [社交儀表板](/help/marketo/product-docs/demand-generation/social/social-functions/view-social-performance.md).
...
1. 為您的社交按鈕命名，選取 **無** 從 **複製來源**，然後按一下 **插入**.
   ...
   [將登入頁面發佈至Facebook](/help/marketo/product-docs/demand-generation/facebook/publish-landing-pages-to-facebook.md) [將社交按鈕放置到您的網站上](/help/marketo/product-docs/demand-generation/social/social-functions/deploy-social-on-your-website.md)
