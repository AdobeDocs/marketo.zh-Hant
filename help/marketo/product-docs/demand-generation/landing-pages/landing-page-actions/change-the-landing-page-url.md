...
1. 輸入「 **New URL**」（新建URL），選擇捨棄或重新導向舊URL，然後按一下「 **Save」（儲存）。**

   ![](assets/two.png)

   >[!NOTE]
   >
   >如果您決定要同時保留兩個URL，則會自動建立重新導向規則。 進一步瞭解 [URL重新導向](http://docs.marketo.com/display/public/DOCS/Redirect+a+URL+Path)。
