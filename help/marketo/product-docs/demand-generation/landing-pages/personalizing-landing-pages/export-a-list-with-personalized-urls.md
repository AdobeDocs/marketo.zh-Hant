...
description: 瞭解如何從Marketo匯出包含個人化URL的清單。 取得具有唯一登陸頁面URL的收件者清單。
title: 匯出具有個人化 URL 的清單
...
# 匯出具有個人化 URL 的清單 {#export-a-list-with-personalized-urls}
...
1. 檢查&#x200B;**[!UICONTROL Include Personalized URL]**，尋找並選取您要產生PURL的登陸頁面。
