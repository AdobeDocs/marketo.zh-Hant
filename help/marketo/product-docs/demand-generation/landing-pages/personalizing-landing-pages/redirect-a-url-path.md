...
1. 按一下 **規則** 標籤，然後按一下 **新增** 和 **新的重新導向規則**.
...
1. 按一下 **使用非Marketo登陸頁面**，在中，輸入您要重新導向訪客的頁面 **重新導向URL** 欄位，然後按一下 **建立**.
   ...
   您可以 [使用Marketo登陸頁面](/help/marketo/product-docs/demand-generation/landing-pages/landing-page-actions/redirect-a-marketo-landing-page-to-another-page.md) 作為目的地。
