...
description: 瞭解如何將SSL新增至您的Marketo登陸頁面。 啟用HTTPS以提供安全的登陸頁面URL。
...
>[!IMPORTANT]
>
>在新增SSL之前，請務必檢查您的合約，以瞭解允許新增的網域總數。 否則，您可能需要支付相關費用。 如果找不到相關資訊，請洽詢Adobe客戶團隊（您的客戶經理）以取得詳細資料。
...
## 編輯SSL到現有的網域別名 {#edit-ssl-existing-domain}
...
* **預先存在的SSL**：新增網域時，系統會檢查預先存在的SSL （可能之前已手動建立）。 如果您遇到此驗證，請在不選取SSL建立的情況下建立您的網域，我們會為您連線。 [連絡支援人員](https://nation.marketo.com/t5/support/ct-p/Support){target="_blank"}以取得其他詳細資訊或選項。
