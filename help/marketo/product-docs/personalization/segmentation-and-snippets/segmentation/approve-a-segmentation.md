...
1. 在分段中，按一下 **分段動作**，然後 **核准**.

   ![](assets/image2017-3-28-14-3a46-3a22.png)

   >[!NOTE]
   >
   >狀態會變更為使用旋轉滾輪核准( ![](assets/image2014-9-15-15-3a31-3a43.png))，而核准仍在進行中。

   >[!CAUTION]
   >
   >視資料庫大小而定，核准可能需要幾分鐘至一天以上的時間才能完成。

   核准後，「狀態」會從「核准」變更為「已核准」。
...
1. 此 **人員** 索引標籤中的 **區段** 現在會顯示該區段的最終人員清單。
