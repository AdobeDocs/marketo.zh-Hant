...
>[!NOTE]
>
>此功能處於開放Beta版中，目前正在未來幾個月內分階段推出。 當您在「我的Marketo」畫面上看到&#x200B;_具有AI的Build_&#x200B;圖磚，就會知道您的訂閱已啟用它。
...
1. 按一下&#x200B;**匯入銷售機會**&#x200B;代理程式。
   ...
   系統會將您帶往對話式AI畫面。 左窗格會顯示指引、回應和可用的資料標準化選項。
...
匯入完成後，驗證摘要隨即出現，顯示已處理的潛在客戶、失敗的列以及任何警告。
