...
>[!NOTE]
>
>此功能處於開放Beta版中，目前正在未來幾個月內分階段推出。 當您在「我的Marketo」畫面上看到&#x200B;_使用AI建置_&#x200B;圖磚，就會知道您的訂閱已啟用此功能。

>[!IMPORTANT]
>
>為您的訂閱啟用此功能後，您必須執行一些[設定步驟](/help/marketo/product-docs/marketo-ai/settings-setup.md)，以確保想要的使用者有存取權。
