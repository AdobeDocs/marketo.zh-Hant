---
description: 單一電子郵件傳送方案範本。 使用它來傳送具有明確命名慣例的一次性電子郵件行銷活動。
title: EM-YYYY-MM-DD-單封電子郵件傳送
feature: Programs
...
# EM-YYYY-MM-DD-單封電子郵件傳送 {#em-yyyy-mm-dd-single-email-send}
...
>[!TIP]
>
>在您的表單上線並傳送電子郵件之前，啟動「01參與」行銷活動以追蹤成功。
