...
1. 按一下「**[!UICONTROL Program Actions]**」下拉式選單，選取「**[!UICONTROL Delete]**」。

   ![](assets/image2014-9-23-15-3a41-3a11.png)

1. 選取「全部刪除……」選項按鈕。 檢閱刪除程式的效果，然後按一下&#x200B;**[!UICONTROL Delete]**&#x200B;確認。

>[!TIP]
>
>封存程式可保留程式資料，但會阻擋您的前進。 選取該選項，然後按一下「**[!UICONTROL Next]**」即可檢視有關封存的詳細資料。
...
1. 按一下「**[!UICONTROL Used By]**」以檢視資產的使用位置。
