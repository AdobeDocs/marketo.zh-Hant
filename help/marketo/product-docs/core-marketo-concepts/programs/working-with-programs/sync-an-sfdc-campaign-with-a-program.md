...
1. 選擇&#x200B;**建立新**，或選擇現有的Salesforce促銷活動。
   ...
   >[!TIP]
   >
   >如果您選取現有的Salesforce促銷活動，請確定[符合Salesforce促銷活動和Marketo程式](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/sfdc-errors/how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync.md)的程式狀態。
