...
>[!PREREQUISITES]
>
>您需要先啟用[Salesforce促銷活動同步](/help/marketo/product-docs/crm-sync/salesforce-sync/setup/optional-steps/enable-disable-campaign-sync.md)。
...
1. 選擇&#x200B;**新建**&#x200B;或選擇現有的Salesforce促銷活動。
   ...
   >[!TIP]
   >
   >如果選擇現有的Salesforce促銷活動，請確保[匹配Salesforce促銷活動和Marketo方案](/help/marketo/product-docs/crm-sync/salesforce-sync/sfdc-sync-details/how-to-match-program-statuses-and-salesforce-campaign-statuses-prior-to-sync.md)的方案狀態。
