...
description: 瞭解如何依標籤篩選計畫報告。 檢視具有特定標籤之程式的效能。
title: 按照標記篩選方案報告
...
# 按照標記篩選方案報告 {#filter-a-program-report-by-tag}
...
1. 選取您的&#x200B;**[!UICONTROL Program Performance]**&#x200B;報告。

   ![](assets/image2014-9-23-16-3a12-3a36.png)

1. 按一下「**[!UICONTROL Setup]**」標籤，並拖曳至&#x200B;**[!UICONTROL Tags]**&#x200B;篩選器之一。
...
1. 完成！ 按一下「**[!UICONTROL Report]**」標籤，檢視&#x200B;_僅_&#x200B;符合報表中所選標籤的程式。
