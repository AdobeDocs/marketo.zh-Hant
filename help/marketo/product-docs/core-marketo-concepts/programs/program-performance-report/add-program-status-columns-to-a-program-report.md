...
description: 瞭解如何將方案狀態列新增至方案報告。 在報表欄中加入成員狀態。
title: 將方案狀態欄新增至方案報告
...
# 將方案狀態欄新增至方案報告 {#add-program-status-columns-to-a-program-report}
...
1. 按一下「**[!UICONTROL Setup]**」標籤，並拖曳至「**[!UICONTROL Channel]**」標籤上。
...
1. 核取顯示計畫狀態列的選項。 按一下「**[!UICONTROL Apply]**」。
