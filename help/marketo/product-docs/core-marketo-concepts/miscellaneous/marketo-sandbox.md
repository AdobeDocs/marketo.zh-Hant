...
* 如果您想要新增使用者，程式與[在生產環境中新增使用者](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#add-a-user)相同。 同樣地，如果他們已經擁有Marketo登入資訊，則必須使用不同的電子郵件地址。
