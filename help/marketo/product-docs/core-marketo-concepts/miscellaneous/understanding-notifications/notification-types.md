...
description: 瞭解Marketo中的通知型別，包括行銷活動失敗、CRM同步和參與。 瞭解每個警報的意義。
title: 通知類型
...
當人們在資料流中精疲力盡時，就會傳送通知。 通知包括筋疲力盡的人數和某些其他資訊。
...
>[!NOTE]
>
>您可能會收到的部分錯誤碼在[開發人員檔案](https://experienceleague.adobe.com/zh-hant/docs/marketo-developer/marketo/rest/error-codes)中概述。
