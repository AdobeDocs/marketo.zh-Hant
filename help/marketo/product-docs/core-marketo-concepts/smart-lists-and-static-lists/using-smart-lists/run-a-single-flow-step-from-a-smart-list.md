...
1. 按一下 **[!UICONTROL 全選]**. 您也可以使用 **Ctrl/Cmd** 並按一下，以手動選取一些記錄。
...
1. 在 **[!UICONTROL 個人動作]**，選取您選取的流程步驟。 在此範例中，我們將使用 [變更資料值](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/flow-actions/change-data-value.md){target="_blank"}.
...
1. 如果您要變更大量人員的資料值，您可能需要輸入數字以確認變更。 按一下 **[!UICONTROL 大膽試一試]**.
