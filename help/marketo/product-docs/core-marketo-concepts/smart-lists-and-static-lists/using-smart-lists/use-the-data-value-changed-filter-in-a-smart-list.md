...
此篩選器將尋找所有已變更（任何變更）其狀態的人。 如果您想要更想要，請嘗試[將限制新增至智慧清單篩選器](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/add-a-constraint-to-a-smart-list-filter.md){target="_blank"}。
