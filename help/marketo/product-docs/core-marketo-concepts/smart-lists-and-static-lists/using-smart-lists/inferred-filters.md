...
當有人瀏覽您的網站時，[Munchkin](/help/marketo/product-docs/administration/additional-integrations/add-munchkin-tracking-code-to-your-website.md)會將它們放入系統。 我們在一個特殊的資料庫中查找他們的IP，並推斷出各種好的資訊。 看看。
...
當您在智慧型清單中使用這些篩選器時，結果會讓使用者看到這個推斷的資訊。
...
這些匿名訪客在點按電子郵件連結或填寫表格時，會自動轉換成訪客。 但是，它們保留所有推斷的資訊。
