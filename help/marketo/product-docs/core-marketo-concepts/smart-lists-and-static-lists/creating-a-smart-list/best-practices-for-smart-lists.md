...
1. **自行使用隨機範例 —**&#x200B;隨機範例是一種特殊的篩選器。 單獨使用它可將您的人員放入預先製作的清單中。 然後使用「清單成員」讓您的智慧清單超快。 隨機範例將&#x200B;**NOT**&#x200B;與巢狀智慧列示搭配使用。 如果隨機範例篩選器是為「智慧清單成員」篩選器所參照的智慧清單，則該篩選器將無法運作。
...
1. **簡化您的行銷活動 —** 100+個獨立規則顯然需要一些時間處理。 保持簡單，您將會注意到速度提升，而且更容易理解。
