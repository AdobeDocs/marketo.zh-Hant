...
靜態清單是Marketo最簡單且實用的功能之一。 它們是資料庫中的名稱清單。 您會找到許多使用理由。
...
>[!CAUTION]
>
>最常見的錯誤之一就是您認為可以透過「刪除人員」將人員從清單中移除。 **這是錯誤的**。 刪除人員將會從&#x200B;**整個資料庫**&#x200B;中刪除他們，而不只是清單。

## 從清單新增或移除人員的方法 {#ways-to-add-remove-people-from-a-list}
