...
* 清單從Marketo上傳至Adobe Audience Manager後，Adobe Target也可加以存取。 必須在Adobe Target](https://experienceleague.adobe.com/en/docs/target/using/integrate/audience-manager-target-integration){target="_blank"}中啟用該組態[。
