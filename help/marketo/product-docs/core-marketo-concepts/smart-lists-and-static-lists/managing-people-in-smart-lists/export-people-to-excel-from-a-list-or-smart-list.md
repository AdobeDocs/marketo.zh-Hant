...
description: 瞭解如何從清單或智慧清單將人員匯出至Excel。 下載清單中的人員以進行報告。
...
如果您需要Marketo外部的清單或智慧清單結果，可以匯出至Excel。
...
1. 將會執行匯出。 完成之後，您可以按一下&#x200B;**[!UICONTROL Download now]**&#x200B;以抓取檔案。
   ...
   >[!TIP]
   >
   >如果匯出需要一點時間，您隨時可以登出稍後再返回。 選取&#x200B;**[!UICONTROL List Actions]**&#x200B;功能表中的&#x200B;**[!UICONTROL Show Export Status]**，即可存取&#x200B;**[!UICONTROL Download now]**&#x200B;連結，有效期限為一週。
