...
1. 在智慧型清單中，按一下「智慧型清單」**標籤，尋找「 **Revenue Stage** 」篩選器，並將其拖曳至畫布中。
...
## 在收入階段的成員上運行流步驟 {#run-a-flow-step-on-the-members-of-a-revenue-stage}

既然您知道哪些人處於收入階段，您就可以直接向他們行銷。 除了選 **擇「收入階段** 」做為智慧型清單篩選外，您也可以選擇它作為流程中的「if」篩選。

1. 在所要的流程步驟中，按一 **下「新增選擇** 」，然後從下 **拉式清單中選取「收入階段** 」。
