...
1. 按一下 **[!UICONTROL 人員]** 標籤。 選取人員 **[!UICONTROL Id]** 數字。
...
1. Excel檔案會下載至瀏覽器。
   ...
   >[!MORELIKETHIS]
   >
   >進一步瞭解 [篩選活動記錄](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/filter-activity-types-in-the-activity-log-of-a-person.md){target="_blank"} 以檢視特定人員活動。
