...
1. 選取包含您要刪除之所有人員的清單/智慧清單，並前往 **[!UICONTROL 人員]** 標籤。
...
1. 按一下 **[!UICONTROL 全選]**. 您也可以使用Ctrl/Cmd並按一下，以手動挑選一些記錄。
   ...
   >[!NOTE]
   >
   >如果結果跨越多個頁面，請按一下 **[!UICONTROL 全選]** 將會選取所有頁面上的所有人員。

1. 若要從Marketo中完全移除人員，請按一下 **[!UICONTROL 刪除人員]**.

   ![](assets/four-1.png)

1. 設定 **[!UICONTROL 從CRM移除]** 至 **[!UICONTROL true]** 如果您也想要從CRM刪除記錄。
...
1. 如果您要刪除50位以上的人員，您將會看到此訊息。 輸入您要刪除的人員數目，檢查 **[!UICONTROL 無法還原]** 方塊，然後按一下 **[!UICONTROL 刪除]**.

   ![](assets/seven.png)

   >[!NOTE]
   >
   >若要檢視大量刪除的結果，請按一下 **[!UICONTROL 檢視結果]** 在熒幕右上角的「單一流量動作」彈出式方塊中。 刪除時間會因多因素而有很大的差異。
