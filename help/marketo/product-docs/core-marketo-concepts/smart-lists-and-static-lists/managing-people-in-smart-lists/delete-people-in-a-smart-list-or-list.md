...
1. 選取包含您要刪除之所有人員的清單/智慧清單，並移至&#x200B;**[!UICONTROL People]**&#x200B;標籤。
...
1. 若要從Marketo中完全移除人員，請按一下&#x200B;**[!UICONTROL Delete Person]**。

   ![](assets/four-1.png)

1. 如果您也想要從CRM刪除記錄，請將&#x200B;**[!UICONTROL Remove from CRM]**&#x200B;設為&#x200B;**[!UICONTROL true]**。
...
1. 按一下「**[!UICONTROL Run Now]**」。

   ![](assets/image2014-9-24-13-3a0-3a3.png)

1. 如果您要刪除50位以上的人員，您將會看到此訊息。 輸入您要刪除的人員數目，核取&#x200B;**[!UICONTROL Cannot Undo]**&#x200B;方塊，然後按一下&#x200B;**[!UICONTROL Delete]**。
