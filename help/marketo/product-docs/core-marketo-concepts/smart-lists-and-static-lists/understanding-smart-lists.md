...
您可以 [編輯智慧清單名稱](/help/marketo/product-docs/core-marketo-concepts/miscellaneous/rename-a-marketo-asset.md) 並檢視智慧清單的相關資訊。

![](assets/smartlist.png)

## 人員標籤 {#people-tab}

這是您檢視結果的地方；例如，符合您篩選條件的所有人員 [已新增和定義](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/find-and-add-filters-to-a-smart-list.md) 在「智慧列示」標籤下。
