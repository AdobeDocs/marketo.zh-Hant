...
1. 在&#x200B;**資料庫**&#x200B;中，可供共用/全域使用（例如「所有已取消訂閱的使用者」）。
1. 在&#x200B;**方案**&#x200B;中作為本機資產，他們在該資產中找到與該特定方案相關的一組人員（例如，「參加貿易展」）。
...
您可以[編輯智慧列示名稱](/help/marketo/product-docs/core-marketo-concepts/miscellaneous/rename-a-marketo-asset.md){target="_blank"}，並檢視智慧列示的相關資訊。

![](assets/understanding-smart-lists-1.png)

## 人員標籤 {#people-tab}

這是您檢視結果的位置；也就是說，所有符合您在「智慧清單」標籤下[新增並定義](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/creating-a-smart-list/find-and-add-filters-to-a-smart-list.md){target="_blank"}之篩選條件的人。
