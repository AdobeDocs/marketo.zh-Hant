...
1. 輸入篩選值。
   ...
   若要一次觸發一個人的即時活動，請瞭解如何 [定義Smart Campaign的智慧清單 |觸發器](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/define-smart-list-for-smart-campaign-trigger.md){target="_blank"}.
