...
按一下 **排程** 索引標籤會確認Smart Campaign已設為「批次」。
...
* 顯示於 [方案排程檢視](/help/marketo/product-docs/core-marketo-concepts/programs/program-schedule-view/navigating-the-program-schedule-view.md). 在Smart Campaign中「等待」步驟之後的任何內容都不會包含在檢視中。
...
按一下 **排程** 索引標籤會確認Smart Campaign已設為「已觸發」。
...
>[!TIP]
>
>使用 [活動記錄](/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/managing-people-in-smart-lists/locate-the-activity-log-for-a-person.md) 以檢視Smart Campaigns中逐步發生的情況。 您可以在人員詳細資訊頁面的最後一個標籤中找到活動記錄。
