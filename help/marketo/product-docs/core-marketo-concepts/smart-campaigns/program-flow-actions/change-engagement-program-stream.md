...
通常您會 [串流轉變規則](/help/marketo/product-docs/email-marketing/drip-nurturing/engagement-program-streams/transition-people-between-engagement-streams.md) 若要達到此目的，但如果您想要手動將人員從一個資料流移至另一個資料流，則需使用此資料流步驟。
