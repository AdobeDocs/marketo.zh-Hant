...
description: 瞭解如何檢視Smart Campaign結果。 檢視誰符合資格、執行了流程以及採取了哪些動作。
title: 檢視智慧行銷活動結果
...
1. 按一下&#x200B;**[!UICONTROL ID]**&#x200B;以檢視有關該特定活動的詳細資訊。
   ...
   深入瞭解結果，以檢視您的行銷活動實際做什麼，或[將Smart Campaign結果匯出至Excel](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/smart-campaign-data/export-smart-campaign-results-to-excel.md){target="_blank"}。
