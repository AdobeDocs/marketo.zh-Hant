...
# 了解智慧型行銷活動 {#understanding-smart-campaigns}
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>篩選</td> 
   <td>已點按連結</td> 
   <td><p>按批次收集當前符合資格的所有人員。</p></td> 
  </tr> 
  <tr> 
   <td colspan="1">觸發</td> 
   <td colspan="1">點按連結</td> 
   <td colspan="1">當有人做某件事時，立即啟動流。</td> 
  </tr> 
 </tbody> 
</table>
...
最後，當您執行智慧行銷活動時，這會控制。 您甚至可以設定重複執行，使其以重複排程執行。

聰明的競選可以做很多事情。 掌握它，你會發現Marketo的一切都變得簡單易懂。

>[!CAUTION]
>
>如果您將智慧型促銷活動從一個方案移至另一個方案，而促銷活動的智慧清單或流程步驟會參考原始方案，則您必須手動更新資訊以反映其新方案，如同 **not** 自動更新。
