...
>[!TIP]
>
>您也可以 [在方案排程檢視中重新排程批次智慧行銷活動](/help/marketo/product-docs/core-marketo-concepts/programs/program-schedule-view/reschedule-a-batch-smart-campaign-in-the-program-schedule-view.md){target="_blank"}.

1. 選取您要執行的批次智慧行銷活動，前往 **[!UICONTROL 排程]** 標籤，然後按一下 **[!UICONTROL 執行一次]**.

   ![](assets/schedule-a-batch-smart-campaign-to-run-later-1.png)

1. 按一下 **[!UICONTROL 稍後執行]**，然後按一下日曆圖示，並選取您要執行智慧行銷活動的日期。
