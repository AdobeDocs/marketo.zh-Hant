...
# 於智慧行銷活動套用通訊限制 {#apply-communication-limits-to-smart-campaign}

>[!PREREQUISITES]
>
>[啟用通訊限制](/help/marketo/product-docs/administration/email-setup/enable-communication-limits.md){target="_blank"}

一天多次傳送電子郵件給某人，或一週內傳送太多郵件，不是個好主意，對嗎？ 幸運的是，Marketo Engage有溝通限制可提供協助。
...
1. 核取&#x200B;**[!UICONTROL Block non-operational emails]**&#x200B;核取方塊，然後按一下&#x200B;**[!UICONTROL Save]**。
