...
1. 檢查 **[!UICONTROL 封鎖非營運電子郵件]** 核取方塊，然後按一下 **[!UICONTROL 儲存]**.
...
>[!TIP]
>
>若要將其設為預設值，請編輯您的 [通訊限制](/help/marketo/product-docs/administration/email-setup/enable-communication-limits.md){target="_blank"} 在管理員區段中。
