...
description: 瞭解如何將流程步驟新增至Smart Campaign。 插入動作，例如傳送電子郵件、變更資料值或新增至清單。
...
[在您排程或啟動智慧型行銷活動之前，請先檢閱及驗證](/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/smart-campaign-checklist.md){target="_blank"}。
