...
代號是變數。 您可以將其用於電子郵件、登陸頁面和智慧型行銷活動，讓您的生活更輕鬆。 您可以使用 [我的Token](/help/marketo/product-docs/core-marketo-concepts/programs/tokens/understanding-my-tokens-in-a-program.md) （自訂Token）的流量、Webhook、電子郵件和登入頁面。 您可以使用代號，將變數內容納入這些流程步驟中：
