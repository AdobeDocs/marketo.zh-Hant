...
若要準備[!DNL iPad]或[!DNL Android]平板電腦：
...
## 使用[!DNL iPad]或平板電腦簽入人員

在活動上：

* 登入應用程式
* 尋找來賓（並建立新人員）
* [簽入來賓](/help/marketo/product-docs/core-marketo-concepts/mobile-apps/event-check-in/check-people-into-your-event-from-your-tablet.md){target="_blank"} （反向簽入，簽入時編輯人員記錄）
* 將[!DNL iPad]或[!DNL Android]平板電腦應用程式與Marketo同步
