...
Marketo的強大功能已掌握在手中。 直接從您的手機或iPad預覽和重新排程電子郵件。
...
**[!UICONTROL On-Deck]** — 此電子郵件即將寄出。 這是您預覽範例、傳送範例，甚至於必要時取消的最後機會。

![](assets/image2015-7-17-11-3a25-3a48.png)

**[!UICONTROL Heart-beat]** — 此電子郵件正在傳遞，包括統計資料。 與您的團隊共用。

![](assets/image2015-7-17-11-3a27-3a22.png)

**[!UICONTROL Results]** — 顯示電子郵件的執行方式。 電子郵件執行完畢後，「結果」卡片會顯示參與分數和其他統計資料。
...
>**定義**
>
>* [!UICONTROL Favorite]：如果您將專案設為[我的最愛]，很容易注意到最及時且最重要的專案。
>* [!UICONTROL Done]：「完成」可讓您從Marketo的「時刻」檢視中移除（但保留在Marketo中，安全無虞）。
>* [!UICONTROL Share]：傳送影像以激勵或祝賀您的團隊。
>* [!UICONTROL Send Sample] （僅限電子郵件）：使用此功能讓其他人檢閱您的電子郵件在您傳送出去之前的面貌。
>* [!UICONTROL Preview Email] （僅限電子郵件）：最好事先檢閱您的電子郵件。
...
電子郵件計畫卡會顯示關鍵詳細資訊，例如排程、對象、狀態和其他有用資訊，即使您午餐時間在外也一樣。
...
在此過程中的每個步驟，您都可以確認或取消動作。 如果您改變心意，請點選&#x200B;**[!UICONTROL Never Mind]**。
