...
在啟動之前，驗證程式會自動根據Marketo最佳實務和表面問題檢查您的設定。 深入瞭解[驗證計畫技能](/help/marketo/product-docs/coworker-for-marketo/skills/validate-programs.md){target="_blank"}。

### 匯入銷售機會 {#import-leads}

透過欄位對應協助，將潛在客戶清單匯入並刪除重複專案至Marketo Engage資料庫。 深入瞭解[匯入銷售機會技能](/help/marketo/product-docs/coworker-for-marketo/skills/import-leads.md){target="_blank"}。
