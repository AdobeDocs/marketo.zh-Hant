...
1. 在「我的Marketo」中，按一下「**[!UICONTROL Coworker for Marketo Engage]**」圖磚。
...
定義Marketo Engage的同事在建立或修改Marketo Engage資產時，所遵循的組織准則與限制。
...
_此索引標籤可能會顯示在UI中，但尚未可供使用。 請檢查這篇文章是否有更新_。
