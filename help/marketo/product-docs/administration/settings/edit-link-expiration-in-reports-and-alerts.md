...
description: 如何變更報告訂閱電子郵件中的連結保留有效天數。
title: 編輯報告和警報中的連結期限
...
# 編輯報告和警報中的連結期限 {#edit-link-expiration-in-reports-and-alerts}
...
1. 按一下「**[!UICONTROL Edit URL Expiration]**」。

   ![](assets/edit-link-expiration-in-reports-and-alerts-3.png)

1. 在下拉式清單中，選取連結過期前的天數。 按一下「**[!UICONTROL Save]**」。
