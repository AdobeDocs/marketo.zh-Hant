...
* 針對[!DNL Munchkin]，將`{"anonymizeIP",true}`新增至[init函式](https://experienceleague.adobe.com/en/docs/marketo-developer/marketo/javascriptapi/leadtracking/configuration){target="_blank"}。
