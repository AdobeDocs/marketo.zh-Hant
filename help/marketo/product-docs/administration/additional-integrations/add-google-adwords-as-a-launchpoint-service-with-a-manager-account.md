...
description: 使用LaunchPoint中的管理員帳戶將多個 [!DNL Google AdWords] 帳戶與Marketo整合。
...
1. 按一下「**[!UICONTROL New]**」下拉式選單，選取「**[!UICONTROL New Service]**」。
...
1. 取消選取您不想要更新的帳戶。 按一下「**[!UICONTROL Create]**」。
