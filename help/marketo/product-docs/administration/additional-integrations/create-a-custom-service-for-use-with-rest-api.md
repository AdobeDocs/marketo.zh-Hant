...
>[!TIP]
>
>請參閱我們的開發人員檔案，以取得有關[REST API](https://developer.adobe.com/marketo-apis/)的詳細資料。 如果您需要的話，我們也有[SOAP API](https://experienceleague.adobe.com/zh-hant/docs/marketo-developer/marketo/soap/soap-api)。
