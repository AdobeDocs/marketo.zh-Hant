...
description: 將Adobe Connect新增為LaunchPoint服務，讓Marketo可管理網路研討會報名與出席情形。
...
1. 輸入&#x200B;**[!UICONTROL Display Name]**。 在&#x200B;**[!UICONTROL Service]**&#x200B;底下，選取Adobe Connect。

   ![](assets/add-adobe-connect-as-a-launchpoint-service-4.png)

1. 輸入您的&#x200B;**[!UICONTROL Username]**&#x200B;和&#x200B;**[!UICONTROL Access Code]**。

   ![](assets/add-adobe-connect-as-a-launchpoint-service-5.png)

1. 輸入您的&#x200B;**[!UICONTROL Meeting Folder URL]**&#x200B;和&#x200B;**[!UICONTROL Participant Password]**，然後按一下&#x200B;**[!UICONTROL Create]**&#x200B;以完成程式。
