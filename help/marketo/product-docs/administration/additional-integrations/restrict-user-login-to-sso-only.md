...
>[!TIP]
>
>若您選取&#x200B;**[!UICONTROL 需要SSO]**，您可以在設定角色時，勾選&#x200B;**[!UICONTROL 略過單一登入]**&#x200B;選項，將[使用者角色](/help/marketo/product-docs/administration/users-and-roles/create-delete-edit-and-change-a-user-role.md)從此限制中排除。 這可讓使用者正常登入。 例如，管理員使用者可能仍需要透過登入畫面登入Marketo。
