...
[標籤](/help/marketo/product-docs/core-marketo-concepts/programs/working-with-programs/understanding-tags.md)是用來描述程式。 您可以視需要製作任意數量的元件，每個元件都具有唯一值。 以下步驟說明如何管理這些值。
...
1. 輸入&#x200B;**[!UICONTROL Value]**&#x200B;並按一下&#x200B;**[!UICONTROL Add Another]**。 您可以視需要新增任意數量的值。
