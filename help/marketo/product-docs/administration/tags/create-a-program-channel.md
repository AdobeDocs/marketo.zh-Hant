...
1. 按一下「**[!UICONTROL Tags]**」。
   ...
   >[!NOTE]
   >
   >為何選擇標籤？ 頻道是描述節目的一種方式，就像其他標籤一樣。 此頻道具有特殊的額外功能。

1. 按一下「[!UICONTROL Channel]」旁的「**+**」符號以展開並檢視現有管道。
...
1. 在&#x200B;**[!UICONTROL New]**&#x200B;底下，按一下&#x200B;**[!UICONTROL New Channel]**。
   ...
   >* 成功：已出席
   >
   >檢視現有管道的進度，以取得使用管道的指引。

1. 以派對頻道為例，為您的新&#x200B;**[!UICONTROL Channel]**&#x200B;命名，並選取要套用它的節目型別。

   ![](assets/create-a-program-channel-5.png)

   >[!NOTE]
   >
   >有數種型別的計畫。 將管道與正確的型別配對。 如果不確定，請選擇&#x200B;**[!UICONTROL Default]**。
...
1. 輸入其他程式&#x200B;**[!UICONTROL Status]**&#x200B;和&#x200B;**[!UICONTROL Step]**&#x200B;號碼，然後按一下&#x200B;**[!UICONTROL Add Step]**。
   ...
   >[!TIP]
   >
   >**[!UICONTROL Step]**&#x200B;編號用於排序程式狀態。 請注意，人們不能在這些循序漸進的步驟中後退。 他們只能將狀態變更為更高或相等的值狀態。 當狀態要來回切換而不是進度時，請使用相等值。
...
1. 選取&#x200B;**[!UICONTROL Registered]**&#x200B;的&#x200B;**[!UICONTROL Mobile Check-in Status]**。

   ![](assets/create-a-program-channel-9.png)

1. 選取&#x200B;**[!UICONTROL Attended]**&#x200B;的&#x200B;**[!UICONTROL Mobile Check-in Status]**。
