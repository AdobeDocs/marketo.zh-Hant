---
description: 如何在Adobe Admin Console中新增或移除Marketo Engage使用者，方法是選取產品設定檔並管理使用者索引標籤。
title: 新增或移除使用者
...
1. 輸入要新增的使用者名稱、使用者群組或電子郵件地址。 名字和姓氏為選用。
...
>[!NOTE]
>
>透過Adobe Admin Console將使用者新增到Marketo Engage時，他們會在訂閱的預設工作區中獲得「標準使用者」角色。 如果需要調整使用者在工作區中的角色，請在Marketo Engage [中完成此操作，如此處所述](/help/marketo/product-docs/administration/users-and-roles/managing-user-roles-and-permissions.md){target="_blank"}。
