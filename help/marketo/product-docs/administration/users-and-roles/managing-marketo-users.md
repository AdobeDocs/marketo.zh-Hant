...
>[!IMPORTANT]
>
>本文僅適用於&#x200B;_不_&#x200B;使用[Marketo搭配Adobe身分識別](/help/marketo/product-docs/administration/marketo-with-adobe-identity/adobe-identity-management-overview.md){target="_blank"}的使用者。 如果是，請依照[本文章](/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md){target="_blank"}中的步驟進行。
