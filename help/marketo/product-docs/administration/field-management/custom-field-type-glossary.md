...
>[!NOTE]
>
>大部分欄位不是以字元數為上限，而是以位元組數為上限。 因此，Marketo無法為每個欄位提供最終的字元限制。 例外狀況是&#x200B;**字串**，最大為255個字元。

## 布林值 {#boolean}

**範例名稱：**&#x200B;為Customer — 將人員標籤為客戶
...
**範例名稱：**&#x200B;備用電子郵件 — 保留人員的備用電子郵件地址（實際上無法像預設電子郵件位址列位一樣將電子郵件傳送至此欄位）
