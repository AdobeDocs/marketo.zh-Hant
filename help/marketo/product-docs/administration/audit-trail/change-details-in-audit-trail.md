...
稽核軌跡提供許多insight，讓您瞭解誰在您的Marketo訂閱中執行什麼操作。
...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td rowspan="15"><strong>預設方案</strong><br><br><br><br><br><br><br><br><br><br><br></td>
   <td>建立</td>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td>智慧清單報表</td>
   <td>編輯</td>
   <td>已編輯供登入下載的智慧清單：「true或false」</td>
  </tr>
  <tr>
   <td rowspan="7">使用者<br><br><br><br></td>
   <td>建立（邀請）</td>
   <td>邀請使用者：電子郵件「電子郵件地址」、姓名「名字和姓氏」、存取權到期時間「空白或帶日期」、API使用者「true or false」 — <br>顯示指派給使用者的角色和工作區快照</td>
  </tr>
  <tr>
   <td colspan="1">刪除</td>
