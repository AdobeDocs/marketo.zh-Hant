...
description: 建立新工作區的步驟，包括命名、選取人員分割、選擇主要品牌領域以及設定工作區語言。
title: 建立新的工作區
...
>[!NOTE]
>
>如需詳細資訊，請參閱[瞭解工作區和人員分割](/help/marketo/product-docs/administration/workspaces-and-person-partitions/understanding-workspaces-and-person-partitions.md){target="_blank"}。
...
1. 輸入&#x200B;**[!UICONTROL Name]**，然後選取您要使用的&#x200B;**[!UICONTROL Person Partitions]**。 選擇&#x200B;**[!UICONTROL Primary Person Partition]**。 確定[人員資料分割](/help/marketo/product-docs/administration/workspaces-and-person-partitions/create-a-person-partition.md){target="_blank"}已建立（如果尚未建立）。
