...
1. 在&#x200B;**[!UICONTROL Segmentation]**&#x200B;區段中選取&#x200B;**[!UICONTROL Segment By]**。
...
1. 從樹狀結構中選取區段。 按一下取消訂閱文字，然後按一下連結圖示。
...
## 在電子郵件中使用程式碼片段 {#use-a-snippet-in-an-email}

1. 在電子郵件編輯器中，按一下可編輯的元素。 然後按一下齒輪圖示並選取&#x200B;**[!UICONTROL Replace with Snippet]**。 如果您選取可編輯的程式碼片段元素，請按一下齒輪圖示並選取&#x200B;**[!UICONTROL Edit]**。
...
1. 按一下不同的語言以檢視程式碼片段變更。
   ...
   >[!TIP]
   >
   >您也可以針對動態語言編輯電子郵件的其餘部分。 在取消訂閱頁面上使用相同技術。

## 使用動態內容自訂您的取消訂閱頁面 {#customize-your-unsubscribe-page-with-dynamic-content}
...
1. 尋找&#x200B;**[!UICONTROL Preferred Language]**&#x200B;區段。 按一下「**[!UICONTROL Save]**」。
   ...
   >[!NOTE]
   >
   >深入瞭解[動態內容](/help/marketo/product-docs/personalization/segmentation-and-snippets/segmentation/understanding-dynamic-content.md)。
