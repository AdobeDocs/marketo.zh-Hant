...
以下是Marketo Classic介面的舊圖示。 目前的圖示字彙表可以是 [可在此處找到](/help/marketo/getting-started-2/things-to-know/icon-glossary.md){target="_blank"}.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>電子郵件程式已排程為開始時間</td> 
  </tr> 
  <tr> 
   <td><img src="assets/image2015-1-5-11-3a51-3a1.png"> 
    </td> 
   <td>Smart Campaign — 排程批次（勾號表示它以前曾執行）</td> 
  </tr> 
  <tr> 
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>重新整理（通常是執行計數、報表、智慧清單）</td> 
  </tr> 
  <tr> 
   <td><img src="assets/image2015-1-5-16-3a1-3a29.png"> 
    </td> 
   <td>檢視智慧型成員（先前限定的和目前的）</td> 
  </tr> 
 </tbody> 
</table>

### 行銷活動功能表 {#campaign-menus}
