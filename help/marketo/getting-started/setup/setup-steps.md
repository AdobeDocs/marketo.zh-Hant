...
1. 登入Marketo [此處](https://app.marketo.com/){target=&quot;_blank&quot;}，使用您收到的電子郵件憑證。

   ![](assets/setup-steps-1.png)

恭喜您！你現在在Marketo，可以開始探索。 您可能想要邀請行銷團隊的同事加入。 您可以新增使用者來完成此操作。
...
若要擷取將替換為登錄頁面CNAME的帳戶字串，請前往「管理員」區域。
...
這是 `[AccountString]`. 保存。 您需要在步驟5中將其提供給IT。
...
`1)` 針對我們的登錄頁面，新增DNS項目(CNAME) **[LandingPageCNAME]**.**[CompanyDomain]**.com，指向 **[AccountString]**.mktoweb.com。
...
您對Marketo的表現有何期望？ 行銷活動的規模和複雜性可能會有所不同。 但您可以預期的效能層級與「標準」欄中所列的數個表格相同，這些表格位於 [Marketo Engage產品說明](https://helpx.adobe.com/legal/product-descriptions/adobe-marketo-engage---product-description.html){target=&quot;_blank&quot;}。 「效能」和「效能加」列是指提供以下功能的效能層包 [更高的效能級別](https://nation.marketo.com/t5/product-documents/marketo-engage-performance-tiers/ta-p/328835){target=&quot;_blank&quot;}。
