...
歡迎使用Marketo！ 您可以隨意使用下列檢查清單作為視覺化的待辦事項清單，以開始辦事。 您可以在[設定步驟](/help/marketo/getting-started/initial-setup/setup-steps.md){target="_blank"}中找到詳細資料。
...
1. 在[!UICONTROL Admin]區域中設定DKIM和SPF
