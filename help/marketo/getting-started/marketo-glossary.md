...
以下是使用Marketo時可能會遇到的許多辭彙定義。 若要要求新增詞語，請 [傳送電子郵件給我們](mailto:GRP-Marketo-articlefeedback@adobe.com).
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1">可讓您修改電子郵件的元件（例如主旨列、寄件者地址等） 並設定測試准則，以判斷哪組內容效果更佳。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>帳戶</strong></td> 
   <td colspan="1">這個辭彙可能有不同的含義：<br> — 您的Marketo執行個體本身可稱為您的Marketo帳戶。<br>-In <strong>TAM</strong>， a <strong>具名帳戶</strong> 是使用者已判斷為要追求的目標帳戶帳戶。<br> — 在TAM中，CRM帳戶是從您連結的對應帳戶 <strong>CRM</strong> (帳戶於 <strong><span class="dnl">Salesforce</span></strong>， <strong><span class="dnl">MS Dynamics</span></strong> 或 <strong>API</strong>)。<br> — 在您的CRM中，帳戶是與潛在客戶和聯絡人相關聯的企業/公司。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">（前身為AccountAI），位於 <strong>TAM</strong>，使用您的理想客戶設定檔(ICP)，將排名資料庫中的現有公司，並將排名新增為帳戶上的分數。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">在Marketo中認識某個人的日期。 此日期對應至 <strong>贏取方案</strong> 已取得該人員。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>贏取方案</strong></td> 
   <td colspan="1">負責取得人員的程式。 該人員可能是匿名的，而此方案負責將其轉換為已知人員。 這有助於建立首次接觸歸因。</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">（前身為Ad Bridge）將Marketo的不重複受眾資料連結至付費媒體系統的方法，讓您可執行更具針對性、個人化的數位廣告行銷活動。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>Adobe Marketo Engage</strong></td> 
   <td colspan="1">Adobe Experience Cloud內所有Marketo產品集合的官方品牌名稱。</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">用於通知您已指定的人員收到有關交易的電子郵件的通知。</td> 
  </tr> 
  <tr> 
   <td><strong>匿名訪客</strong></td> 
   <td>從未填妥表單或在網站上留下詳細資訊的網站訪客。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">用於確認何時 <strong>資產</strong> 已可供使用。 資產未經核准前，無法公開檢視。</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>A <strong>行銷活動</strong> 使用篩選器或清單成員資格來鎖定合格成員。 批次行銷活動會在特定時間啟動，並一次影響一組特定人員。 批次行銷活動可設為重複或執行一次。<br></p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> 您不想要收到行銷資料的Marketo人員（例如競爭者）欄位。 當您將「封鎖清單」欄位設為true時，該人員將不會收到來自您的Marketo執行個體的任何電子郵件，包括操作電子郵件。</td> 
  </tr> 
  <tr> 
   <td> 
    <div> 
     <p><strong><a href="/help/marketo/product-docs/email-marketing/deliverability/hard-and-soft-bounces-in-email.md" rel="nofollow">彈回</a></strong></p> 
    </div></td> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">顯示電子郵件效能測量結果的報表型別，依下列專案分組： <strong>智慧型行銷活動</strong>.</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong><a href="/help/marketo/product-docs/core-marketo-concepts/miscellaneous/create-new-campaign-folder.md" rel="nofollow">Campaign資料夾</a></strong></td> 
   <td colspan="1">可容納多個專案的組織單位 <strong>計畫</strong> 和/或 <strong>智慧型行銷活動</strong>. 就像案頭上的資料夾一樣，Marketo中的資料夾是用於組織和報告。</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">轉換是從「 」傳送電子郵件的事件。 <strong>參與計畫</strong>.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">與相關聯的行銷活動型別 <strong>方案</strong> (例如電子郵件、 <strong>網路研討會， </strong>商展、路演、線上廣告等)。 </td> 
  </tr> 
  <tr> 
   <td><strong>按一下以開啟%</strong></td> 
   <td>已開啟且有連結在電子郵件中點按的電子郵件百分比。 此量度方式會透過採取不重複點按次數除以不重複開啟次數，然後乘以100來測量電子郵件的相關性和內容，以百分比顯示。</td> 
  </tr> 
  <tr> 
   <td><strong>點擊次數</strong></td> 
   <td>依預設，電子郵件中的連結內嵌追蹤，可讓您檢視誰點按了哪個連結、點選了多少總連結等。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">新增至的資訊 <strong>資產</strong>，例如 <strong>電子郵件</strong> 或 <strong>登陸頁面</strong>. 在 <strong>參與計畫</strong>，您可以使用的內容型別有兩種 <a href="/help/marketo/product-docs/email-marketing/drip-nurturing/creating-an-engagement-program/understanding-engagement-programs.md#content" rel="nofollow">新增至串流</a> — 電子郵件和 <strong>計畫</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">0到100分的評分，Marketo會提供您的內容在 <strong>參與計畫</strong>. 分數由複雜的公式決定，使用 <strong>開啟次數</strong>， <strong>點按次數</strong>， <strong>取消訂閱</strong>、計畫成功等。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>Cookie</strong></td> 
   <td colspan="1"><span>Cookie是從網站傳送至使用者網頁瀏覽器的小段資料，以協助個人化體驗（記住登入資訊、偏好設定等）。 </span></td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">在Facebook中，建立由特定現有人員(來自您的Marketo資料庫)組成的清單以進行直接目標定位。</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>的核心區段之一 <strong>Adobe Marketo Engage</strong>. 資料庫是您的所有 <strong>人員</strong> 記錄。</td> 
  </tr> 
  <tr> 
   <td><strong>重複資料刪除</strong></td> 
   <td>也稱為重複資料刪除。 識別及整合資訊（例如人員）以消除重複的程式。 例如，當有新人員進入您的執行個體時，Marketo會自動進行重複資料刪除。</td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
   ...
   <td colspan="1">Marketo中的計畫型別。 電子郵件、事件或參與計畫不相關時，您會使用的通用計畫。 <br></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">以增加對組織產品或服務的需求為目的而使用目標式行銷的行為。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>人口統計分數</strong></td> 
   <td colspan="1">根據個人擁有的特定屬性（例如職稱、收入規模或目標產業）指派的點值。 通常用於衡量個人是否適合您的產品或公司。 </td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>Design Studio</strong></td> 
   <td colspan="1">的核心區段之一 <strong>Adobe Marketo Engage</strong>. Design Studio是您的家 <strong>資產</strong>，例如： <strong>登陸頁面</strong>，表單， <strong>電子郵件</strong>， <strong>代碼片段</strong>和影像/檔案。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>檔案</strong></td> 
   <td colspan="1">檔案簡稱，檔案是幫助客戶更好地瞭解產品的相關文章。 Marketo有數種不同型別的檔案：產品檔案（您目前所在的網站）、 <a href="https://developers.marketo.com/" rel="nofollow">開發人員</a> 檔案，以及 <a href="https://nation.marketo.com/t5/Knowledgebase/tkb-p/support_solutions-documents" rel="nofollow">支援</a> 檔案。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>網域型訊息驗證、報告和符合性(DMARC)</strong></td> 
   <td colspan="1">以DNS為基礎的電子郵件安全性原則，可標準化操作和解釋 <strong>SPF</strong> 和 <strong>DKIM</strong>，允許信箱提供者驗證聲稱來自網域的郵件是否來自該網域的有效來源。 它進一步允許寄件者指定如何處理驗證失敗的郵件。</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">保護傳送網域的驗證機制，可讓傳送者將「寄件者地址」中的網域名稱與特定電子郵件訊息建立關聯。 如此一來，接收者便可得知電子郵件是由網域擁有者合法傳送。 寄件者將在郵件標頭中使用數位簽章來簽署電子郵件。 接收者可以使用網域擁有者在DNS中發佈的公開金鑰來解密該簽名，以確保該郵件是由網域擁有者合法傳送。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>草稿</strong></td> 
   <td colspan="1"><p>一個 <strong>電子郵件</strong> 或 <strong>登陸頁面</strong> 尚未提供 <strong>已核准</strong> 尚未。 草稿獲得核准後，才能公開檢視。 您可以傳送草稿作為測試電子郵件（範例），但不會記錄任何分析。 <br></p></td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>滴水行銷活動</strong></td> 
   <td colspan="1"><span>一種直接行銷方法，涉及傳送客戶/潛在客戶一段較長時間的一系列通訊。</span></td> 
  </tr> 
  <tr> 
   <td colspan="1"><a href="/help/marketo/product-docs/email-marketing/deliverability/durable-unsubscribe.md" rel="nofollow"><strong>永續性取消訂閱</strong></a></td> 
   <td colspan="1">主版取消訂閱狀態，可確保 <strong>已取消訂閱</strong> 人員被移除並重新建立，或者如果使用現有的已取消訂閱的相同電子郵件地址建立新記錄，則該記錄將保持已取消訂閱。</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1">在Marketo中， <strong>資產</strong> 可用於與您的客戶溝通。 電子郵件可以是HTML（圖形、自訂字型等）或僅限文字（無特殊格式的純文字訊息）。 只有HTML電子郵件可以記錄「開啟次數」。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>電子郵件無效</strong></td> 
   <td colspan="1">Marketo中的預設欄位，代表您的網站中是否有個人的電子郵件地址。 <strong>資料庫</strong> 為交付專案。</td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
   ...
   <td colspan="1">Marketo中的計畫型別。 電子郵件程式用於一次性電子郵件傳送。 您可以利用 <strong><a href="/help/marketo/product-docs/email-marketing/email-programs/email-program-actions/email-test-a-b-test/add-an-a-b-test.md" rel="nofollow">A/B測試</a></strong> 以及追蹤您的電子郵件結果。<br></td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">一個狀態，可封鎖某人在24小時之後收到電子郵件 <strong>硬跳出</strong> 發生。 24小時後，該人員會再次變成可郵寄狀態。 </td> 
  </tr> 
  <tr> 
   <td colspan="1"> 
    <div> 
   ...
   <td colspan="1">Marketo中的計畫型別。 參與計畫可讓您透過系統地提供內容（也稱為nurture program）來向新人進行行銷。<br></td> 
  </tr> 
  <tr> 
   ...
   <td>根據專有演演算法的分數，該演演算法會考慮：參與行為(<strong>開啟次數</strong>， <strong>點按次數</strong>，計畫成功)和脫離行為（取消訂閱）。</td> 
  </tr> 
  <tr> 
   ...
   <td>為了與您的客戶和潛在客戶溝通而發生的事。 離線事件通常包含集會或商展，線上事件則通常是 <strong>網路研討會</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Marketo中的計畫型別。 事件程式可用來自動執行 <strong>事件</strong>，包括離線和線上講座（例如網路研討會、聚會、商展等）。  </td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">當個人已收到參與資料流中的每個內容片段時。 標示為已耗竭的人將維持其狀態，直到其他 <strong>內容</strong> 已新增。</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>使用於中的工具 <strong>智慧清單</strong> 這可讓您縮小對象範圍（例如，資料庫中居住在加州的所有人）。 篩選器可用於兩者 <strong>批次</strong> 和 <strong>觸發行銷活動</strong>.</td> 
  </tr> 
  <tr> 
   <td><strong>流程</strong></td> 
   <td><p>的區域 <strong>智慧型行銷活動</strong> 會透過「 」中設定的條件，決定您所選擇之人員會有什麼改變。 <strong>智慧清單</strong>. 流量包含一或多個 <strong>流程步驟</strong>.</p></td> 
  </tr> 
  <tr> 
   ...
   <td>也稱為流程動作：針對您選擇的人員/人員發生的動作(作為 <strong>智慧型行銷活動</strong>，來自的單一流量動作 <strong><a href="/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/using-smart-lists/run-a-single-flow-step-from-a-smart-list.md" rel="nofollow">智慧清單</a></strong>，或一個人的單一流量動作)。</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>歐盟法規於2018年5月25日生效，旨在賦予歐盟公民更多掌控其個人資料的權利。</p></td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>在 <strong>Marketo Sales Insight</strong>，即您視為具有特定關聯性的事件（例如，有人造訪您網站上的特定頁面、按一下電子郵件中的特定連結等） 您想讓銷售團隊知道的。</p></td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>Marketo中的任何人員資料 <strong>資料庫</strong> 視為已知的個人資料。 使用者有多種方式可進入您的資料庫，包括：CRM同步、填寫表單、清單匯入/手動輸入、程式化（rest API/合作夥伴整合）等。 網站訪客最初是指 <strong>cookied</strong> （和為匿名），透過Marketo <strong>Munchkin</strong> 網路追蹤，接著在可識別動作發生時(例如，按一下Marketo電子郵件中的追蹤連結、使用電子郵件地址填寫表單，或透過兩者中的Marketo關聯銷售機會API手動對應)，對應至對應的已知個人記錄 <a href="https://developers.marketo.com/javascript-api/lead-tracking/api-reference/#munchkin_associatelead">Munchkin</a> 和 <a href="https://developers.marketo.com/rest-api/endpoint-reference/lead-database-endpoint-reference/#!/Leads/associateLeadUsingPOST">Rest API</a></p></td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colspan="1">人員的集合。 Marketo中有智慧清單和靜態清單。 A <a href="/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/understanding-smart-lists.md" rel="nofollow">智慧清單</a> 是可以持續變更人員的動態清單，因為它是根據您定義的篩選器（例如，資料庫中居住在加利福尼亞的每個人）。 當新人員符合條件（或現有人員不再符合條件）時，清單會變更。 A <a href="/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/static-lists/understanding-static-lists.md" rel="nofollow">靜態清單</a> 是，嗯，靜態。 除非您手動新增/刪除某人，否則不會變更。</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>Adobe Marketo Engage的核心區段之一。 這是您的 <strong>行銷活動</strong> 進行協調流程。 您的所有 <strong>計畫</strong>、行銷活動，和 <strong>行銷活動資料夾</strong> (以及他們的 <strong>本機資產</strong>)請在這裡上線。</p></td> 
  </tr> 
  <tr> 
   <td colspan="1"><a href="https://www.marketo.com/marketing-automation/" rel="nofollow"><strong>行銷自動化</strong></a></td> 
   <td colspan="1">一種技術類別，可讓公司簡化、自動化及衡量行銷工作與工作流程，以便提高營運效率並更快增加收入。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>行銷合格銷售機會(MQL)</strong></td> 
   <td colspan="1">培育受眾的區段後，某些個人可能會成為行銷合格的銷售機會，這表示他們已展現出符合您成功標準的行為和特性，以便轉交給您的銷售組織跟進。</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">此欄位由手動設定 <strong>使用者</strong> 以在Marketo中建立人員 <strong>資料庫</strong> 暫時無法傳送。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>此附加元件具備多方面的銷售工具，可協助行銷人員與潛在客戶互動並追蹤成效。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>Marketo Sales Insight (MSI)</strong></td> 
   <td colspan="1">附加功能，可讓行銷人員使用其銷售人員的行銷見解來增強他們的銷售人員 <strong>CRM</strong>.</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">（前）新一代Marketo介面。 運用全新設計、工作流程和功能，協助您充份運用Marketo。</td> 
  </tr> 
  <tr> 
   <td><strong>Microsoft Dynamics</strong></td> 
   <td>也稱為MSD。 Marketo與原生整合的兩個CRM之一(請參閱 <a href="#c"><strong>CRM</strong></a>)。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Adobe Marketo Engage的標準區段之一。 以您的Marketo「首頁」形式運作，為您有權存取的Marketo所有區段顯示圖磚。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><a href="/help/marketo/product-docs/core-marketo-concepts/programs/tokens/understanding-my-tokens-in-a-program.md" rel="nofollow"><strong>我的Token</strong></a></td> 
   <td colspan="1">任何人都能建立的自訂變數。 它們是 <a href="/help/marketo/product-docs/core-marketo-concepts/programs/tokens/managing-my-tokens.md" rel="nofollow">已建立</a> 在下列任一位置 <strong>行銷活動資料夾</strong> 或 <strong>計畫</strong>.</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>在 <strong>TAM</strong>，使用者已確定的帳戶是他們想要追求的目標帳戶。</p></td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>將影像下載至時開啟的暫存器 <strong>電子郵件</strong>. 即使您沒有包含影像，Marketo預設也會在所有HTML電子郵件中插入單一追蹤畫素。 純文字電子郵件無法註冊一個開啟的郵件。</p></td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1"> 忽略的電子郵件 <strong>已取消訂閱</strong> 和 <strong>行銷活動已暫停</strong> 狀態。 用於重要或自動回應的電子郵件。 不適合行銷。 營運電子郵件不會傳送給具有下列身分的人員： <strong>已加入封鎖清單</strong> 或 <strong>電子郵件無效</strong> 狀態。 <br></td> 
  </tr> 
  <tr> 
   <td><strong>機會</strong></td> 
   <td>機會可以與相關聯 <strong>人員</strong> 或 <strong>帳戶</strong> 作為未來的潛在銷售。 他們通常透過以下方式進入Marketo <strong>CRM</strong>，或透過 <strong>API</strong>.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1">Marketo中的報表型別。 它可讓您測量您電腦的 <strong>資料庫</strong> 隨著時間推移。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">先前稱為Marketo Performance Insights (MPI)。 附加分析功能，使用各種工具來協助您探索趨勢並識別一致的成功策略。</td> 
  </tr> 
  <tr> 
   <td><strong>個人</strong></td> 
   <td>Marketo中的個人 <strong>資料庫</strong> 您正在透過行銷活動與其互動的那些資訊。</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">個人分割區就像是個別分割區 <strong>資料庫</strong>. 每個分割區都有各自的人員，不會進行重複資料刪除或與其他分割區混合。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">Marketo中的輪詢就像定期輪詢一樣。 建立可供他人投票並在您的Marketo上分享的主題 <strong>登陸頁面</strong>、您的網站和/或社群媒體。</td> 
  </tr> 
  <tr> 
   <td> 
    <div> 
   ...
   <td>（先前稱為ContentAI）附加功能，可協助Marketo使用者透過最相關的方式，與網頁訪客和電子郵件收件者互動 <strong>內容</strong>，使用由機器學習和預測性分析支援的建議。</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">此容器包含執行行銷計畫所需的一切。 有四種不同的型別： <strong>活動計畫</strong>， <strong>參與計畫</strong>， <strong>電子郵件程式</strong>、和 <strong>預設程式</strong>)</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>計畫月份</strong></td> 
   <td colspan="1"> 與關聯的月份 <strong>期間成本</strong> 的 <strong>方案</strong>.</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td>當人員符合中的預定准則時 <strong>智慧型行銷活動</strong>，則他們符合資格。 您可以設定資格規則，以決定這些規則可執行的次數 <strong>流量</strong> 在上述智慧行銷活動中。</p></td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1"><p>一段時間的效能分數，由各種訊號和/或資料點組成。 信譽可能與寄件者的網域相關聯， <strong>內容</strong>或IP位址，並影響 <strong>傳遞能力</strong>.</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td>的附加功能包含各種工具，旨在協助您增強執行個體的報告。</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">使用於中的工具 <strong>Revenue Cycle Analytics (RCA)</strong> 會使用一系列階段，讓您追蹤 <strong>銷售機會</strong> 會在您轉換這些變數的任何指定時間點進行。</td> 
  </tr> 
  <tr> 
   <td><strong>角色</strong></td> 
   <td>指派給使用者的標題，將一連串許可權分組（例如管理員、行銷使用者）。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>角色帳戶</strong></td> 
   <td colspan="1">屬於某個部門或職位（例如，security@、sysadmin@等）的電子郵件地址，不是個人電子郵件地址。 Marketo會封鎖郵件傳送至 <a href="https://nation.marketo.com/t5/Support-Blogs/Suppressing-addresses-to-protect-customers-amp-The-Network/ba-p/241295" rel="nofollow">特定角色帳戶</a> 無法與個別訂閱者建立關聯。</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1">也稱為SFDC。 Marketo與原生整合的兩個CRM之一(請參閱 <a href="#c"><strong>CRM</strong></a>)。</td> 
  </tr> 
  <tr> 
   ...
   <td colspan="1">測試 <strong>電子郵件</strong> 您傳送給自己（和/或其他人），檢視傳送給客戶之前的外觀。 您也可以使用範例進行測試 <strong>動態內容</strong>.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">將您的團隊中的人員分組 <strong>資料庫</strong> 根據 <strong>智慧清單</strong> 您指定的規則。 例如，您可以有一個稱為產業的分段，其中的類別可以是：醫療保健、技術、金融等。 區段可讓您根據所選的人口統計資料，將產品行銷給整群人。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colspan="1"><strong><a href="/help/marketo/product-docs/personalization/segmentation-and-snippets/snippets/create-a-snippet.md" rel="nofollow">代碼片段</a></strong></td> 
   <td colspan="1">區塊 <strong>內容</strong> （文字、影像），可以預先建立並快速插入 <strong>登陸頁面</strong>/<strong>電子郵件</strong> 至今為止。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>軟退信</strong></td> 
   <td colspan="1">(請參閱 <a href="#b"><strong>彈回</strong></a>)</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">未經請求的電子郵件最常見的辭彙。</td> 
  </tr> 
  <tr> 
   <td colspan="1"><strong>垃圾郵件陷阱</strong></td> 
   <td colspan="1">ISP和電子郵件安全提供者特別監控的電子郵件地址，用於陷阱垃圾郵件傳送者。 這些可能包括從未使用過的位址、錯字網域和過期的網域。 不同型別的垃圾郵件陷阱可能表示從表單問題獲取的不同問題（打字錯誤垃圾郵件陷阱）、未正確維護資料庫或移除無效地址（過期的網域垃圾郵件陷阱）或經常未經許可透過購買清單（原始垃圾郵件陷阱）獲取地址。 任何傳送至這些地址的郵件都會標示為 <strong>垃圾訊息</strong>.</td> 
  </tr> 
  <tr> 
   <td><strong>分割測試</strong></td> 
   <td>使用兩個或多個變體來測量結果差異的測試實驗。 目標是識別會增加或最大化感興趣結果的網頁變更。</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colspan="1">已排定優先順序的集合 <strong>內容</strong> 用於 <strong>參與計畫</strong> 培養人才。 <a href="/help/marketo/product-docs/email-marketing/drip-nurturing/creating-an-engagement-program/add-content-to-a-stream.md" rel="nofollow">內容</a> 會以您指定的順序分發。</td> 
  </tr> 
 </tbody> 
</table>
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>啟動「 」的活動或事件 <a href="/help/marketo/product-docs/core-marketo-concepts/smart-campaigns/creating-a-smart-campaign/define-smart-list-for-smart-campaign-trigger.md" rel="nofollow">觸發器行銷活動的流程步驟</a> 當所述事件發生時（例如，有人瀏覽網頁、按一下電子郵件中的連結等）。 </td> 
  </tr> 
  <tr> 
   <td> 
    <div> 
...
<table> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colspan="1">當 <strong>人員</strong> 選擇不再接收行銷電子郵件，這是選擇退出的另一個詞語。</td> 
  </tr> 
  <tr> 
...
<table> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Marketo中的報表型別。 它可讓您檢視已知的 <i>或</i> 正在造訪您網站的匿名人員。</td> 
  </tr> 
  <tr> 
   ...
   <td>此附加功能提供目標定位和個人化平台，可協助Marketo使用者根據已知和匿名訪客的身份和行為，即時與其互動。</td> 
  </tr>
  <tr> 
  ...
  <tr> 
   ...
   <td>此附加功能可協助Marketo使用者(透過Facebook和Google)使用根據產業、具名帳戶和已知資料的相關廣告來鎖定已知和匿名訪客。</td> 
  </tr> 
  <tr> 
   <td><strong>您所見即所得（所見即所得）</strong></td> 
   <td>一個通用辭彙，用來指稱可讓您檢視應用程式或編輯器的最終結果 <strong>內容</strong> 當您建立它時。 Marketo有WYSIWYG編輯器。</td> 
  </tr> 
  <tr> 
   <td><strong>Widget</strong></td> 
   <td>應用程式中允許特定互動的小型圖形元素。 Widget只能用於Marketo Sky(與 <a href="/help/marketo/product-docs/web-personalization/working-with-web-campaigns/create-a-new-widget-web-campaign.md" rel="nofollow">Widget Web行銷活動)</a></td> 
  </tr> 
  <tr> 
