...
感謝您參與新的Marketo Engage UI測試版。 此更新會更新Marketo Engage的樣式並改善回應能力，完全不會變更功能。 存取新UI時，會使用主題選擇器，該選擇器會出現在Marketo Engage中大部分頁面的右上角。
...
1. 按一下&#x200B;**存取新主題**&#x200B;核取方塊，然後按一下&#x200B;**儲存**。

熒幕擷圖

## 全新和傳統UI {#new-and-classic}

若要切換至新的UI，請按一下右上角的主題下拉式清單，然後選取&#x200B;**新增(Beta)**。
