...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td colspan="1">讓您可以修改電子郵件的組成元件 (例如主旨行、寄件者地址等)，並且設定測試準則，藉以判斷哪一組內容較佳。</td>
  </tr>
  <tr>
   <td colspan="1"><strong>帳戶</strong></td>
   <td colspan="1">此術語可能具有不同的含義：<br>－您的 Marketo 執行個體本身可以稱為您的 Marketo 帳戶。<br>－在 <strong>TAM</strong> 中，<strong>已命名帳戶</strong>是指使用者已確定為其想要積極接觸的目標帳戶。<br>－在 TAM 中，CRM 帳戶是從您已連結的 <strong>CRM</strong> (<strong><span class="dnl">Salesforce</span></strong>、<strong><span class="dnl">MS Dynamics</span></strong> 或 <strong>API</strong> 中的帳戶) 對應過來的帳戶。<br>－在您的 CRM 中，帳戶是指與商機及聯絡人相關聯的企業/公司。</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colspan="1">在 <strong>TAM</strong> 中，這是指派給帳戶的分數，可協助您確定其參與程度。</td>
  </tr>
  <tr>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td colspan="1"><strong><a href="/help/marketo/product-docs/reporting/basic-reporting/report-types/campaign-email-performance-report.md" rel="nofollow">行銷活動電子郵件績效報告</a></strong></td>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colspan="1">文件 (Document) 的簡寫，是指能幫助客戶更加了解產品的說明文章。Marketo 有數種不同類型的文件：產品文件 (您目前所在的網站)、<a href="https://experienceleague.adobe.com/zh-hant/docs/marketo-developer/marketo/home" rel="nofollow">開發人員</a>文件，以及<a href="https://nation.marketo.com/t5/Knowledgebase/tkb-p/support_solutions-documents" rel="nofollow">支援</a>文件。</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colspan="1">根據您指定的準則填入<strong>電子郵件</strong>或<strong>登陸頁面</strong>中的內容 (例如影像、程式碼片段、文字等)，讓您能夠為讀者提供個人化的體驗。 </td>
  </tr>
 </tbody>
</table>
...
<table>
 ...
 <tbody>
  <tr>
   ...
   <td><p>在 <strong>Marketo 銷售洞察</strong>中，您認為具有特定相關性，並希望您的銷售團隊留意的情況 (例如有人造訪您網站上的特定頁面、點按電子郵件中的特定連結等)。</p></td>
  </tr>
 </tbody>
</table>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>在 <strong>Adobe Marketo Engage</strong> 中，商機是舊術語 (已替換為<strong>人員</strong>)，用於描述在 Marketo <strong>資料庫</strong>中您透過行銷活動與之互動的個體。在您的 <strong>CRM</strong> 中，商機可能代表不同的概念 (即與<strong>機會</strong>相關聯的個體)，與 Marketo 的功能無關。</td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colspan="1">人員的集合。在 Marketo 中有智慧清單和靜態清單。<a href="/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/understanding-smart-lists.md" rel="nofollow">智慧清單</a>是一個不斷變化的動態人員清單，因為此清單以您定義的篩選器 (例如資料庫中居住在加利福尼亞州的所有人) 為依據。當有新的人員符合準則 (或現有人員不再符合準則) 時，清單就會變更。<a href="/help/marketo/product-docs/core-marketo-concepts/smart-lists-and-static-lists/static-lists/understanding-static-lists.md" rel="nofollow">靜態清單</a>就是靜態的。除非您手動新增/刪除人員，否則清單不會變更。</td>
  </tr>
  <tr>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   <td colspan="1">
    <div>
     <p><a href="/help/marketo/product-docs/reporting/performance-insights/performance-insights-overview.md" rel="nofollow"><strong> 績效洞察</strong></a></p>
    </div></td>
  ...
  <tr>
   <td colspan="1"><a href="/help/marketo/product-docs/core-marketo-concepts/programs/program-performance-report/create-a-program-performance-report.md" rel="nofollow"><strong>方案績效報告</strong></a></td>
...
<table>
 ...
 <tbody>
  ...
  <tr>
   ...
   <td>網頁型研討會。在 Marketo 中，可以透過許多不同的<strong><a href="/help/marketo/product-docs/demand-generation/events/understanding-events/event-partners.md" rel="nofollow">事件合作夥伴進行</a></strong>網路研討會。</td>
  </tr>
  <tr>
