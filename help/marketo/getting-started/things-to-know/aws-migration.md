...
如需最新資訊，請將此頁面加入書籤。 若要在移轉開始和完成時接收狀態更新，請[訂閱](https://experienceleague.adobe.com/zh-hant/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"}以接收更新。 您也可以在移轉期間造訪https://status.adobe.com/ 。
