...
若要取得狀態更新，您可以[訂閱以在移轉開始和完成時收到這些更新](https://experienceleague.adobe.com/en/docs/marketo/using/getting-started/things-to-know/system-status-notifications){target="_blank"}。 您也可以在移轉期間造訪[https://status.adobe.com/](https://status.adobe.com/){target="_blank"}。
