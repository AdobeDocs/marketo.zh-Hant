...
<br/>     若是如此，您的「Adobe Admin Console系統管理員」是否已授予您「Adobe Admin Console產品管理員」角色？ 如果不確定組織內誰擁有主控台的管理員權限，請和 <a href="https://helpx.adobe.com/tw/contact.html" target="_blank">Adobe 客戶服務</a>聯絡。</li>
...
<br/>     如果沒有，請確定<a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md" target="_blank">在Adobe Admin Console中，從Marketo Engage產品設定檔新增和/或移除使用者</a>。 如果您將使用者新增至產品設定檔，您無法在「Marketo Engage &gt;管理員&gt;使用者和角色」中指派使用者。</li>
...
<li>登陸頁面<a href="https://nation.marketo.com/t5/knowledgebase/setting-up-secured-domains-for-marketo-landing-pages-first-time/ta-p/250370" target="_blank">的</a>安全網域是否已啟用？
