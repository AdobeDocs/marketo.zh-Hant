...
<br/>若是如此，您的「Adobe Admin Console系統管理員」是否已授予您一個「Adobe Admin Console產品管理員」角色？ 如果您不確定組織中的哪些人擁有主控台中的管理員許可權，請聯絡<a href="https://helpx.adobe.com/tw/contact.html" target="_blank">Adobe客戶服務</a>。</li>
...
<br/>如果沒有，請確定<a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md" target="_blank">在Adobe Admin Console中的Marketo Engage產品設定檔中新增和/或移除使用者</a>。 如果您將使用者新增至產品設定檔，您無法在「Marketo Engage &gt;管理員&gt;使用者和角色」中指派使用者。</li>
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <p>
   <li>有多少使用者？</li>
<li>是否有任何應<a href="/help/marketo/product-docs/administration/users-and-roles/add-or-remove-a-user.md#remove-a-user" target="_blank">移除</a>的使用者？</li>
...
<li>使用了多少欄位？
<br/>在[欄位動作]下拉式清單中選取<a href="/help/marketo/product-docs/administration/field-management/export-used-by-data-for-a-field.md" target="_blank">匯出使用者</a>，以檢閱欄位的相關資產。</li>
...
<br/>若是如此，請按一下它們以瞭解哪些活動與Marketo表單、電子郵件或登入頁面無關。</li></td>
  </tr>
  <tr>
   <td>自訂物件</td>
...
<p><img src="assets/note-icon.png" alt="附註圖示"> 注意：請聯絡Adobe支援以識別自訂同步篩選器，或要求實作自訂同步規則。</li></td>
  </tr>
  <tr>
   <td>登陸頁面</td>
...
<li>您是否達到或接近達到API限制？
<br/>若是如此，請考慮增加它或稽核您的執行個體，以停止這些API呼叫。</li></td>
  </tr>
  <tr>
