...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   <td>影像和檔案</td>
   <td><li>需要更新網頁<a href="/help/marketo/product-docs/demand-generation/images-and-files/find-the-url-of-an-uploaded-image-or-file.md" target="_blank">上參考的任何影像或檔案</a>嗎？
...
<table style="table-layout:auto">
 <tbody>
  ...
  <tr>
   ...
   <p><img src="assets/note-icon.png" alt="附註圖示"> 注意：請務必瞭解這一點，因為在一個Workspace中採取的動作可能會導致其他使用者無法存取其他Workspace中的資產。</td>
  </tr>
 </tbody>
</table>
