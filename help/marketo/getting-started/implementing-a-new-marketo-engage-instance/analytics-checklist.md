...
<tbody>
  <tr>
    ...
    <li><a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/reporting/basic-reporting/editing-reports/change-a-report-time-frame">使用報告的相關時間範圍</a> （例如YTD、過去90天等），以準確檢視標準電子郵件參與度和傳遞能力量度。</li>
