...
<tbody>
  ...
  <tr>
    <td>範本</td>
    <td><li>使用設計工具/開發人員設計以模組為基礎的<a href="https://experienceleague.adobe.com/en/docs/marketo/using/product-docs/email-marketing/general/email-editor-2/create-an-email-template" target="_blank">電子郵件範本</a>，或使用您自己的HTML。</li>
